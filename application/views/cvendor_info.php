        ...
        <div class="mainContentSection flex">
            ...
            <div class="mainRight">
                ...
                <div class="mainBasicInfoSection">
                    <!-- <form method="post" action="<?php //echo base_url(); ?>add-detail"> -->
                        ...
                        <div class="VendorDeatil">
                            <div class="VendorDetailSection">
                                <div class="VEndorDetailLabelInput robotoReguler mainInfoInputS upperCase flex" style="flex-wrap: wrap;">
                                    <label for="Fabric Code" class="infoInputLabel8 robotoMedium labelTitle">Name<sup style="color:red;">*</sup></label>
                                    <input type="text" name="swatch_card" class="infoInputTxt infoInput8" placeholder="" id="swatch_card" oninput="newcvendor_info_error()" />
                            ...
                            <div class="vendorContact">
                                ...
                                <div class="flex mainInfoInputS vndrcntctemlalt ">
                                    <div class="vndrcontcteml robotoReguler upperCase flex" style="flex-wrap: wrap;">
                                        ...
                                        <input type="text" name="email" class="infoInputTxt vndrcontctemlInput newcvendoremail" id="email"  oninput="newcvendor_email_error()" />
                                    ...
                                    <div class="vndrcontctno robotoReguler upperCase flex" style="flex-wrap: wrap;">
                                        ...
                                        placeholder=""  id="contact_no" oninput="newcvendor_contact_error()"/>
                                    ...
                                    <div class="vndrcontctaddress robotoReguler upperCase flex" style="flex-wrap: wrap;">
                                        ...
                                        <input type="text" class="infoInputTxt vndrcontctaltaddress newcvendoraddress"
                                        placeholder="" name="address" id="address" oninput="newcvendor_address_error()"/>
                                    ...
                                    <div class="vndrcontctGSTIN robotoReguler upperCase flex" style="flex-wrap: wrap;">
                                        <label for="Fabric Code" class="robotoMedium labelTitle">GSTIN NO.</label>
                                        <input type="text" class="infoInputTxt vndrcontctaltGSTIN newcvendorgstin"
                                        placeholder="" name="gstin_no" id="gstin_no" oninput="newcvendor_gstin_error()"/>

                                        <span class="error_cvendor_gstin" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left:76px;margin-top: 3px;">* This field is invalid</span>
                                    </div>
                                </div>
                            </div>
                            <div class="vendorContact">
                                ...
                                <div class="vndrcontctprice mainInfoInputS robotoReguler upperCase flex">
                                    ...
                                    <div class="PriceNoRups flex">
                                        <input type="text" class="infoInputTxt vndrcontctaltprice"
                                            placeholder="" id="fabric_cost" name="fabric_cost" />
                                ...
                                <div class="mainBillsection  mainInfoInputS">
                                    <div class="vndrcontctbill robotoReguler upperCase flex">
                                        ...
                                        <a href="javascript:void(0)" onclick="add()" class="vendrBillIcon">
                                        ...
                                        <input type="hidden" name="bill_no_total" id="billaddIcon" value="0">
                                    </div>
                                </div>
                                <div class="mainBillsection  mainInfoInputS">
                                    <div class="vndrDebitnote robotoReguler upperCase flex">
                                        ...
                                        <!-- <input type="text"
                                            ...
                                            placeholder="80000" id="debit_note" /> -->
                                        <!-- <span id="debitnoteadd"></span> -->
                                        <span id="debitnote"></span>
                                        <a href="javascript:void(0)" onclick="debitnoteadd()" class="vendrBillIcon">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen billaddIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-plus"></use>
                                            </svg>
                                        </a>

                                        <input type="hidden" name="debit_note_total" id="debitaddIcon" value="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex fullchooseBrowsFile mainInfoInputS robotoReguler">
                                ...
                                <input type="hidden" name="id" id="id" value="1">
                                 ...
                                 <div class="minSaveBtn flex">
                                    <input type="button" class="saveBtn upperCase blueBtn btn" value="SAVE" href="javascript:void(0)" onClick="cvendor_detail()">
                                </div>
                            </div>
                        </div>
