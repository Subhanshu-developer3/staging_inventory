            ...
            <div class="mainRight mainaddFebric">
               <!--  <form action=""> -->
                    <div class="flex addFebRicTopBtns robotoReguler">
                        <a href="javascript:void(0)"  class="btn upperCase tabViewBtn upperCase"></a>
                        ...
                        <div class="flex addFebricSrchtoggle">
                            ...
                            <a  href="javascript:void(0)" onclick="unarchieve_allid()">
                                <img src="https://inventory.deebaco.com/assets/images/achive-img.png" alt="">
                            </a>
                    ...
                    <table class="adminTable robotoReguler newdata" cellpadding="0" cellspacing="0">
                        ...
                        <?php 
                            ...
                            <tr class="tableBdyRaw">
                                ...
                                <?php  } else {?>
                                onClick = "edit_disable_initial_fabric_detail('<?php echo $data->record_slug0; ?>')" <?php } ?>>
                                <?php 
...
<script type="text/javascript">
    ...
    function unarchieve_allid()
    {
       var unarchieve_allid = $("#archieve_allid").val();

       var baseurl = 'https://inventory.deebaco.com/index.php/';
       $.ajax({
            url: baseurl + 'unarchieve_fabric',
            method: 'POST',
            data: {
            type: 'unarchieve_fabric', unarchieve_allid:unarchieve_allid },
