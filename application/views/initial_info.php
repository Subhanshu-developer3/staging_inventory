...
<html lang="en">
   <head>
      ...
      <title> Basic Info Details </title>
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
      <link rel="stylesheet" href="https://inventory.deebaco.com/assets/style/style.css" />
   </head>
   <body>
      ...
      <div class="header flex">
         <div class="logo">
            <img src="https://inventory.deebaco.com/assets/images/logo.png" alt="" />
         </div>
         <div class="headerIcons flex">
            <a href="#" class="HeaderIcon headerBell">
               <img src="https://inventory.deebaco.com/assets/images/notification_icon.png" alt="">
            </a>
            <a href="#" class="HeaderIcon HeaderUser">
               <img src="https://inventory.deebaco.com/assets/images/user_login.png" alt="">
            </a>
         </div>
      </div>
      ...
      <div class="mainContentSection flex">
         ...
         <div class="mainRight">
            <div class="flex tabViewBtns robotoReguler">
               ...
               <a href="javascript:void(0)" class="btn upperCase tabViewBtn whiteBack" onclick="showcvendornwdata('<?php echo $hash_id; ?>')" >Vendor Details</a>
            </div>
            <!-- ===================information=================== -->
            <form action="">
               <div class="mainBasicInfoSection">
                  <div class="information section">
                     <p class="heading robotoMedium upperCase">Basic Information</p>
                      ...
                      <?php 
                        ...
                        $fabric_basic_data = $fabric_temporary_data[0]->basic_data;
                        $basic_data = json_decode($fabric_basic_data);
                        $fabric_codeid = $fabric_temporary_data[0]->id;
                      ?>
                      <div class="flex mainInfoInputS robotoReguler BasicInfoInformaiotn">
                        <div class="maininfoInput1 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel1 labelTitle">Fabric Code <sup style="color:red;">*</sup></label>
                           <div class="requiredmsg infoInput1 flex flexWrap">
                                 <input type="text" id="fabric_code" class="infoInputTxt upperCase completeWidth" value="<?php echo $basic_data->fabric_code; ?>" readonly  style="cursor: not-allowed;"/>

                                 <!-- <p class="errorMsg">this is demo</p> -->
                                 <span class="error_fabric_code" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left: auto;margin-top: 3px;">* This field is invalid</span>
                                 <span class="fabricode_errornew" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left: auto;margin-top: 3px;">* This fabric code has already been used</span>
                           </div>

                        </div>

                        <div class="maininfoInput2 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel2 labelTitle">Fabric Color<sup style="color:red;">*</sup></label>
                           <div class="requiredmsg infoInput6 flex flexWrap">
                             
                             <select type="text" name="fabric_color" id="fabric_color" class="infoInputTxt upperCase completeWidth" onchange="fabricolor_error()" style="cursor: not-allowed;" disabled="true">
                               <option value="" disabled selected hidden class="febricType">select Color</option>


                               <?php 
                               if(!empty($colora)){
                               foreach ($colora as  $value) { ?>
                               <?php echo $value->id; ?>
                               <option value="<?php echo $value->id; ?>" <?php 
                                        if($value->id == $basic_data->fabric_color) { 
                                        echo "selected"; 
                                        } ?> class="febricType">
                             ...
                             <span class="error_fabric_color" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left: 130px;margin-top: 3px;">* This field is invalid</span>

                           </div>
                        </div>
                        <div class="maininfoInput3 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel3 labelTitle">Fabric Type <sup style="color:red;">*</sup></label>
                           <div class="requiredmsg infoInput6 flex flexWrap">
                              
                                <select type="text" class="infoInputTxt upperCase  completeWidth" name="fabric_type" onchange="fabrictype_error()" 
                                style="cursor: not-allowed;" disabled="true">
                                  <option value="" class="febricType" disabled selected hidden>Select type
                                  </option>
                                  <?php 
                                  if(!empty($fabric_type)){
                                  foreach ($fabric_type as $value)
                                  { ?>
                                  <?php echo $value->id; ?>
                                     <option value="<?php echo $value->id; ?>" <?php 
                                        if($value->id == $basic_data->fabric_type) { 
                                        echo "selected"; 
                                        } ?>  class="febricType">
                                ...
                                <span class="error_fabric_type"  style="display:none;font-size:10px;color: #dc3545;margin-top: 3px;">* This field is invalid</span>


                              <!-- <p class="errorMsg">this is demo</p> -->
                           </div>
                        </div>
                        <div class="maininfoInput4 TitleEditBox upperCase flex" id="nwedit1">
                           <div class="requiredmsg infoeditBox4 flex flexWrap">
                              <a onclick="editInfo()">
                              <img src="https://inventory.deebaco.com/assets/images/edit_icon.png" alt=""> </a>
                           </div>
                           
                        </div>

                        <input type="hidden" name="fabric_codeid" id="fabric_codeid" value="<?php echo $fabric_codeid; ?>">
                        <div class="maininfoInput7 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel7 labelTitle">Fabric
                           Pattern <sup style="color:red;">*</sup></label>
                           <div class="requiredmsg infoInput7 flex flexWrap">
                              
                              <select type="text" name="fabric_pattern" id="fabric_pattern" class="infoInputTxt upperCase completeWidth" onchange="fabricdetail_error()" style="cursor: not-allowed;" disabled="true">
                                  <option value="" disabled selected hidden class="FabricPattern">select Pattern</option>
                                  <?php 
                                  if(!empty($fabric_pattern_list)){
                                  foreach ($fabric_pattern_list as  $value) { ?>
                                  <?php echo $value->id; ?>
                                 
                                  <option value="<?php echo $value->id; ?>" 
                                    <?php 
                                        if($value->id == $basic_data->fabric_pattern) { 
                                        echo "selected"; 
                                        } ?> 
                                   class="FabricPattern"><?php echo $value->name; ?></option>    
                                 
                                  <?php } } ?>
                              </select>
                              <span class="error_fabric_pattern" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left: 130px;margin-top: 3px;">* This field is invalid</span>

                              <!-- <p class="errorMsg">this is demo</p> -->
                           </div>
                        </div>
                        <div class="maininfoInput8 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel8 labelTitle">Swatch Card</label>
                           <div class="requiredmsg infoInput8 flex flexWrap">
                           
                              <input type="text" id="swatch_card" class="infoInputTxt upperCase  completeWidth" value="<?php echo $basic_data->swatch_card; ?>" disabled="true" style="cursor: not-allowed;" />
                              <!-- <p class="errorMsg">this is demo</p> -->
                           </div>
                        </div>
                        <div class="mainChooseFile upperCase flex">
                           <div class="mainChoosebrowseFile flex">
                              <label for="Fabric Code" class="infoInputLabel7 labelTitle">IMAGE UPLOAD <sup style="color:red;">*</sup></label>
                              <div class="maininfoInput13 TitleInputBox upperCase chooseFils flex">
                                 <img src="https://inventory.deebaco.com/assets/images/browse_icon.png" alt="">
                                 ...
                                 <span>  BROWSE fOLDER</span><span class="dragText"> OR DRAG & DROP</span>
                                 </label>

                                 <img id="loaderdata" style="display:none;" />
                                 <span class="fabricode_errornew errorfiledatanw upperCase" style="display: block;font-size: 10px;color: rgb(220, 53, 69);width: calc(100% - 105px);margin-top: 3px;display:none;">* This field is invalid</span>
                              </div>
                           </div>
                           <!--<div class="imagePalce upperCase">Image</div>-->
                           <div class="imagePalce upperCase thumb"><a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                                 data-image="images/red-jacket.jpg"
                                 data-target="#image-gallery">
                                <?php 

                               if((strlen($basic_data->file_info_newdata)) > 0)
                               { ?>
                                    <img id="infosrc" src="<?php echo $basic_data->file_info_newdata; ?>"alt="" height="36px" width="52px" />
                               

                               <?php } else {?>
                               
                                     <img id="infosrc" alt="" height="36px" width="52px" />
                               <?php }?>
                        ...
                        <div class="flex SaveBtnRgt">
                           <div class="minSaveBtn flex">
                              <input type="button" class="saveBtn upperCase blueBtn btn" value="SAVE" onClick="info()" id="nwbutton1" style="display:none;">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="defects section">
                        <div class="flex PurchaseHeading">
                           
                           <p class="heading robotoMedium upperCase"> Purchase Detail</p>
                           <div class=" flex">
                             <!--  <a href=""><img src="<?php //echo base_url(); ?>assets/images/achive-img.png" alt=""></a> --><a type="submit" class="addPurchaseBtn upperCase blueBtn btn link" value="" href="#modal-11"> Add Purchase Detail</a>
                           </div>
                        </div>
                        <div class="flex productTable robotoReguler">
                           <div class="product--list-table">
                              <table class="admin-product--tbl">
                                 ...
                                 <tbody>
                                    <?php 
                                     ...
                                     foreach($fabric_purchase_detail as $data)
                                     { ?>
                                       <tr id="<?php echo "id_".$data->id; ?>">
                                          
                                          <td style="text-align:center;"><?php echo $data->invoiceId; ?></td>

                                          <?php   
                                            
                                            $newdata = $this->Crud_model->fetchalldatawithcondition('units','id', $data->cpurchase_qty_units);  
                                            $datanw = $newdata[0]->name;

                                          ?> 
                                          
                                           <?php if(empty($data->cpurchase_qty))
                                                 {
                                                    $cpurchase_qty = 'NA';
                                                 }
                                                 else
                                                 { 
                                                    $cpurchase_qty = $data->cpurchase_qty." ".$datanw;
                                                 } ?>
                                          <td style="text-align:center;"><?php echo $cpurchase_qty;   ?></td>

                                          <?php   
                                            
                                            $newdatanw = $this->Crud_model->fetchalldatawithcondition('units','id', $data->cpurchase_qty_units);  
                                            $datanwnw = $newdatanw[0]->name;

                                          ?> 
                                           <?php if(empty($data->fabric_width)) { $fabric_width = 'NA'; } else {  $fabric_width = $data->fabric_width." ".$datanwnw;
                                           } ?>
                                          <td style="text-align:center;"><?php echo $fabric_width; ?></td>


                                          <?php   
                                            
                                            $nwdatanw = $this->Crud_model->fetchalldatawithcondition('units','id', $data->cpurchase_qty_units);  
                                            $datanwanw = $nwdatanw[0]->name;

                                          ?> 

                                          <td style="text-align:center;"> 
                                          
                                          <?php if(empty($data->cpriceInfo)) { $cpriceInfo = 'NA'; } else {  ?>
                                          <img src="https://inventory.deebaco.com/assets/images/rupees_icon.png" alt=""> 
                                          <?php 
                                            $cpriceInfo = $data->cpriceInfo." METER";
                                           } ?>
                                           
                                          <?php echo $cpriceInfo; ?> 
                                          </td>
                                          <td style="text-align:center;"> 
                                          <?php if(empty($data->total_price)) { echo $total_price = 'NA'; } else {  ?>
                                          <img src="https://inventory.deebaco.com/assets/images/rupees_icon.png" alt="">
                                          <?php 
                                          ...
                                          <?php 
                                              ...
                                              $returndata = $this->Crud_model->fetchalldatawithcondition('fabric_temporary_data', 'record_slug0', $hash_id); 
       
                                              if(!empty($returndata[0]))
                                              {
                                                $idnw = $returndata[0];  
                                                $fabric_code_id = $idnw->id; 
                                            
                                              }  
                                              
                                              $fabricpurchaseid = $data->id;
                                              $datanwdata =  $this->Crud_model->fetchtabledatatwo('inventory','fabric_codeid',$fabric_code_id,'fabricpurchaseid',$fabricpurchaseid);
                                             
                                              $newdatanwqty = $this->Crud_model->fetchalldatawithcondition('units','id', $datanwdata[0]->total_qty_unit);  
                                              $datanwnwqty = $newdatanwqty[0]->name;
                                            
                                              if($datanwdata[0]->total_qty){
                                                  
                                                  echo $datanwdata[0]->total_qty."  ".$datanwnwqty;
                                              }
                                              else{
                                          ...
                                          <td style="text-align:center;"> 
                                              <?php
                                              $newdata = $this->Crud_model->fetchalldatawithcondition('cvendor_detail','id', $data->vendor_details);  
                                              $vendor_details = $newdata[0]->username;
                                              ?>
                                             <?php echo $vendor_details; ?> </td>
                                          <td style="text-align:center;"> <?php echo $data->dateofentry; ?></td>
                                          <td style="text-align:center;"> <?php echo $data->user_added; ?> </td>
                                          <td class="lastChild"> 
                                             <!-- <a href="javascript:void(0)" onclick="add_fabric_inventory_details('<?php echo $hash_id; ?>')"><img src="<?php echo base_url(); ?>assets/images/table_edit.png" alt=""></a>
                                             <a href="javascript:void(0)" onclick="delete_fabric_detail('<?php echo $data->id; ?>')"><img src="<?php echo base_url(); ?>assets/images/tbl_icon2.png" alt=""></a> -->
                                             ...
                                             <a href="<?php echo "#modal_nw_".$data->id; ?>"><img src="https://inventory.deebaco.com/assets/images/table_edit.png" alt="">
                                             </a>

                                             <a href="javascript:void(0)" onclick="add_fabric_inventory_details('<?php echo $hash_id; ?>','<?php echo $data->id; ?>')"><img src="https://inventory.deebaco.com/assets/images/tbl_icon2.png" alt="">
                                             </a>
                                          </td>
                                       </tr>
                                    <?php } ?>
                              ...
                              <input type="hidden" name="total_rows" id="total_rows" value="<?php echo $rowCount; ?>">
                              <input type="hidden" name="hash_id" id="hash_id" value="<?php echo $hash_id; ?>">
                           </div>
                        </div>
                     </div>
                  </div>
       ...
       <!-- popiup model  -->
      <div class="purchasePopup" id="modal-11">
         <a href="#!" class="modal-overlay"></a>
            <div class="modal-dialog modal-dialog-lg">
               <!-- <h4> Add Purchase Details</h4> -->
               
               <div class="modal-content ">
                  <p class="heading robotoMedium upperCase"> Add Purchase Details</p>
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Invoice ID" class="infoInputLabel1 labelTitle"> Invoice ID
                      <sup style="color:red;">*</sup> </label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text"  class="infoInputTxt upperCase completeWidth" placeholder="" 
                        id="invoiceId"  oninput="fabricinvoiceid_error()">
                         <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_fabricinvoiceid">This field is invalid</p>
                         <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_fabricinvoiceid_new">This Invoice Id already exists </p>
                     </div>
                  </div>
                 
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Purchase QTY." class="infoInputLabel1 labelTitle"> Purchase QTY.</label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase lefSideWidth" placeholder=""
                        id="cpurchase_qty">
                        <select type="text" class="infoInputTxt upperCase rightSideWidth" 
                        name="cpurchase_qty_units" id="cpurchase_qty_units">
                            <?php  
                            if(!empty($all_unit)){
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Width" class="infoInputLabel1 labelTitle"> Width</label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase lefSideWidth" placeholder=""
                        id="fabric_width">
                        <select type="text" class="infoInputTxt upperCase rightSideWidth"
                         name="fabric_width_units" id="fabric_width_units">
                             <?php  
                            if(!empty($all_unit)){
                            foreach ($all_unit as $aldata)
                            { ?>
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Price Per MTR" class="infoInputLabel1 labelTitle"> Price Per MTR</label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase lefSideWidth" placeholder=""
                        id="cpriceInfo">
                        
                        <div class="lefSideWidth flex popRupeesBox">
                        <img src="https://inventory.deebaco.com/assets/images/popuprupees.png" alt="" class="">
                     </div>
                  </div>
                  </div>
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Total Price" class="infoInputLabel1 labelTitle"> Total Price</label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase lefSideWidth" placeholder=""
                        id="total_price">
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Vendor" class="infoInputLabel1 labelTitle"> Vendor <sup style="color:red;">*</sup>  </label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                       
                        <select type="text" class="infoInputTxt upperCase completeWidth" 
                        name="vendor_details" id="vendor_details">

                         <option value="" disabled selected hidden class="febricType">Select Vendor</option>
                            <?php  
                            if(!empty($vendor_detail)){
                            foreach ($vendor_detail as $aldata)
                            { ?>
                               <option value="<?php echo $aldata->id; ?>" class="febricType"><?php echo $aldata->username; ?></option> 
                              
                            <?php } } ?>
                        </select> 
                         <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_vendor_details">This field is invalid</p>
                     </div>
                  </div>
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Date Of Entry" class="infoInputLabel1 labelTitle"> Date Of Entry 
                        <sup style="color:red;">*</sup>  </label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="date" class="infoInputTxt upperCase" placeholder=""
                        id="dateofentry" style="width: 600px;" >
                        <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_dateofentry">This field is invalid</p>
                        
                        <!-- <div class="lefSideWidth flex popRupeesBox">
                        <a href="javascript:void(0);"><img src="assets/images/calendar.png" alt="" class=""></a>
                        </div> -->
                  </div>
                  </div>
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Added By" class="infoInputLabel1 labelTitle"> Added By <sup style="color:red;">*</sup>  </label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase completeWidth" placeholder=""
                        id="user_added">
                        <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_user_added">This field is invalid</p>
                     </div>
                  </div>
                  <div class="flex popupBtn robotoReguler">
                     <a href="#" class="btn upperCase popupCancelBtn redBtn upperCase">Cancel</a>
                     <a onclick="addInfomodaldata()" class="btn upperCase blueBtn"> Save</a>
                  </div>
               </div>
            </div>
      </div>
       ...
       { ?>
        ...
        <!-- popiup model  -->
      <div class="purchasePopup" id="<?php echo "modal_nw_".$data->id; ?>">
         <a href="#!" class="modal-overlay"></a>
            <div class="modal-dialog modal-dialog-lg">
               <!-- <h4> Add Purchase Details</h4> -->
                                                                                                                                                                             
               <div class="modal-content ">
                  <p class="heading robotoMedium upperCase"> Edit Purchase Details</p>
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <input type="hidden" name="modaledit" id="modaledit" value="<?php echo $data->fabric_temporary_data_id; ?>">
                     <input type="hidden" name="data_id" id="data_id" value="<?php echo $data->id; ?>">
                     <label for="Invoice ID" class="infoInputLabel1 labelTitle"> Invoice ID
                      </label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text"  class="infoInputTxt upperCase completeWidth" placeholder="" 
                        id="invoiceId" value="<?php echo $data->invoiceId; ?>" disabled="true" style="cursor:not-allowed;">
                         <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_fabricinvoiceid">This field is invalid</p>
                         <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_fabricinvoiceid_new">This Invoice Id already exists </p>
                     </div>
                  </div>
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Purchase QTY." class="infoInputLabel1 labelTitle"> Purchase QTY.</label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase lefSideWidth cpurchase_qty_nw" placeholder=""
                        id="cpurchase_qty_nw" value="<?php echo $data->cpurchase_qty; ?>">
                        <select type="text" class="infoInputTxt upperCase rightSideWidth" 
                        name="cpurchase_qty_units_nw" id="cpurchase_qty_units_nw">
                            <?php  
                            if(!empty($all_unit)){
                            foreach ($all_unit as $aldata)
                            { ?>
                            <?php echo $aldata->id; ?>
                               <option value="<?php echo $aldata->id; ?>" 
                                   <?php 
                                        if($aldata->id == $data->cpurchase_qty_units) { 
                                        echo "selected"; 
                                        } ?> 
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase lefSideWidth" placeholder=""
                        id="fabric_width_nw" value="<?php echo $data->fabric_width; ?>">
                        <select type="text" class="infoInputTxt upperCase rightSideWidth"
                         name="fabric_width_units_nw" id="fabric_width_units_nw">
                              <?php  
                            if(!empty($all_unit)){
                            foreach ($all_unit as $aldata)
                            { ?>
                            <?php echo $aldata->id; ?>
                               <option value="<?php echo $aldata->id; ?>" 
                                   <?php 
                                        if($aldata->id == $data->fabric_width_units) { 
                                        echo "selected"; 
                                        } ?> 
                                 class="febricType"><?php echo $aldata->name; ?></option> 
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase lefSideWidth" placeholder=""
                        id="cpriceInfo_nw" value="<?php echo $data->cpriceInfo; ?>">
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase lefSideWidth" placeholder=""
                        id="total_price_nw" value="<?php echo $data->total_price; ?>">
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        ...
                        <select type="text" class="infoInputTxt upperCase completeWidth" 
                        name="vendor_detail_data" id="vendor_detail_data">
                         ...
                         <option value="" disabled selected hidden class="febricType">Select Vendor</option>
                            ...
                            {                
                              ?>
                               <option value="<?php echo $aldata->id; ?>" 
                                  <?php 
                                        if($aldata->id == $data->vendor_details) { 
                                        echo "selected"; 
                                        } ?>
                                 class="febricType"><?php 
                                       echo $aldata->username; 
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="date" class="infoInputTxt upperCase" placeholder=""
                        id="dateofentry" style="width: 600px; cursor: not-allowed;" value="<?php echo $data->dateofentry; ?>" disabled="true" >
                        <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_dateofentry">This field is invalid</p>
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Added By" class="infoInputLabel1 labelTitle"> Added By </label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        <input type="text" class="infoInputTxt upperCase completeWidth" placeholder=""
                        id="user_added" value="<?php echo $data->user_added; ?> " disabled="true"  style="cursor: not-allowed;">
                        <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_user_added">This field is invalid</p>
                     </div>
                  </div>
                  <div class="flex popupBtn robotoReguler">
                     <a href="#" class="btn upperCase popupCancelBtn redBtn upperCase">Cancel</a>
                     <a onclick="editInfomodaldata()" class="btn upperCase blueBtn"> Save</a>
                  </div>
               </div>
            </div>
      </div>
