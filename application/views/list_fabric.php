    ...
    <style>
        * {
        ...
        .sortfilter {
            ...
            color: rgba(67, 67, 67, 60%);
            appearance: none;
            background: url(../SVG/downfilterarrow.svg) no-repeat 96%;
        ...
        .feblenekDropDown:after {
            content: "";
            position: absolute;
            background-image: url(../SVG/downfilterarrow.svg);
            height: 1.8rem;
            width: 1.8rem;
        ...
        .checkBoxLabel {
            ...
            /* border: 1px solid rgba(67, 67, 67, 60%); */
        ...
        .mainlistview::-webkit-scrollbar {
            height: 5px;
        }

        .mainlistview::-webkit-scrollbar-track {
            box-shadow: inset 0 0 3px 3px #eee;
        }

        .mainlistview::-webkit-scrollbar-thumb {
            background-color: #dbdcde;
        }

        .mainlistview::-webkit-scrollbar-thumb:hover {
            background: #777;
        }

        .tblHeading:nth-child(6),
        .tblData:nth-child(6) {
            width: 100px;
        }
...
<body>
    ...
    <div class="BasicInfoPage">
        ...
        <div class="mainContentSection flex">
            ...
            <div class="mainLeft">
                <ul class="sidebarMenu robotoReguler">
                    <!-- <li class="SidemenuItem upperCase activeMenuItem">
                     ...
                     <li class="SidemenuItem upperCase activeMenuItem submenu"><a href="javascript:void(0);">Fabric Lists</a>
                         <ul>
                            <li class="activesubMenu"><p style="font-size:14px;" 
                                onclick="archieve_nwdetails()">Archive</p></li>
                            <li><p style="font-size:14px;" 
                                onclick="unarchieve_nwdetails()">Unarchive</a></li>
                         </ul>
                     </li>
            ...
            <div class="mainRight mainaddFebric">
               <!--  <form action=""> -->
                    <div class="flex addFebRicTopBtns robotoReguler">
                        <a href="javascript:void(0)" onclick="add_fabric()" class="btn upperCase tabViewBtn blueBtn upperCase">Add Fabric</a>

                       <!--  <a href="javascript:void(0)" onclick="archieve_fabric_data()" class="btn upperCase tabViewBtn blueBtn upperCase">Archieve Fabric</a>  -->

                        <input type="hidden" name="archieve_allid" id="archieve_allid">
                        <div class="flex addFebricSrchtoggle">
                            <div class="addFebsearchBtn flex" style="justify-content: flex-end;">
                                <input type="text" class="upperCase infoInputTxt" style="margin-right: 48px;" id="keywords" placeholder="SEARCH" onkeyup="searchFilter();">
                                <button class="SearchBtn btn ">
                                    <svg viewBox="0 0 32 32" class="icon shapeCodepen headSeachIcon">
                                        <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-Search"></use>
                                    </svg>
                                </button>
                            </div>
                           ...
                           <a href="javascript:void(0)" onclick="archieve_allid()"><img src="https://inventory.deebaco.com/assets/images/unarchive.png" height="35px;" alt=""></a>
                            <div class="ulploadDownload flex">
                                <button class="btn fbHdrIcn downloadBtn">
                                    <svg viewBox="0 0 32 32" class="icon shapeCodepen downloadIcon">
                                        <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#download"></use>
                                    </svg>
                                </button>
                                <button class="btn fbHdrIcn uploadBtn">
                                    <svg viewBox="0 0 32 32" class="icon shapeCodepen uploadIcon">
                                        <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#upload"></use>
                                    </svg>
                                </button>
                            </div>
                        </div>
                    ...
                    <!-------------------new_change_added---------------->
                       <div class="mainfiltrcontent">
                        <div class="flex robotoReguler mainfilterSort">
                            <div class="filterData upperCase">
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                                    ...
                                    <g transform="translate(0.000000,96.000000) scale(0.100000,-0.100000)"
                                        stroke="none">
                                        <path d="M150 805 c0 -31 17 -57 120 -185 l120 -149 0 -176 0 -175 90 67 90
                           68 0 108 0 108 120 149 c103 128 120 154 120 185 l0 35 -330 0 -330 0 0 -35z
                           m558 -67 c-19 -24 -68 -85 -108 -135 l-74 -93 -46 0 -46 0 -74 93 c-40 50 -89
                           111 -108 135 l-34 42 262 0 262 0 -34 -42z m-198 -371 c0 -81 -1 -84 -30 -105
                           l-30 -23 0 106 0 105 30 0 30 0 0 -83z" />
                                    </g>
                                </svg>
                                <span class="filterIcontxt">FILTER DATA</span>
                            </div>

                         <select name="sort" class="sortfilter" id="filterBy" onchange="searchFilter();">
                                <option class="upperCase filterslctoption" value="SORT" selected disabled hidden>SORT
                                </option>
                                <option class="upperCase filterslctoption" value="0">NEWEST FIRST</option>
                                <option class="upperCase filterslctoption" value="1">OLDEST FIRST</option>
                                <option class="upperCase filterslctoption" value="2">LOW INVENTORY</option>
                                <!-- <option class="upperCase filterslctoption" value="">HIGH INVENTORY</option> -->
                            </select>
                        </div>
                        <div class="mainFiltesrUnslstcTxt flex">
                            <div class="feblengthNeck">
                                <div class="flex mainFilterTab">
                                    <a class="feblenekDropDown robotoMedium upperCase" href="#"
                                        onclick="openShortFilters('febric')">Color</a>
                                    <a class="feblenekDropDown robotoMedium  upperCase" href="#"
                                        onclick="openShortFilters('length')">Fabric Pattern</a>
                                    <a class="feblenekDropDown robotoMedium upperCase" href="#"
                                        onclick="openShortFilters('Neck')">Fabric Type</a>
                                </div>
                                <div id="febric" class="ShortFilters" style="display: none;">

                                    <div class="FebRicFilter flex">

                                        <?php 
                                        if(empty($all_colora)) { ?>
                                        <div class="maininputcheckfitrdt flex">
                                            <h3> No Data Available</h3>
                                        </div>  
                                        <?php } else {  ?>

                                        <?php foreach ($all_colora as $key => $data) { ?>
                                        
                                        <div class="maininputcheckfitrdt flex">
                                            <input type="checkbox" id="<?php echo strtolower($data->id); ?>" name="nw"  class="verticleMiddle filtercheckbox">
                                            <label for="all_colora"
                                                class="checkBoxLabel  robotoReguler upperCase verticleMiddle"
                                                for=""><?php echo ucwords($data->color_name); ?></label>
                                        </div> 
                                ...
                                <div id="length" class="w3-container ShortFilters" style="display: none;">
                                     <div class="FebRicFilter flex">
                                        <?php 
                                        if(empty($all_fabric)) { ?>
                                        <div class="maininputcheckfitrdt flex">
                                        ...
                                        <?php foreach ($all_fabric as $key => $data) { ?>
                                        <div class="maininputcheckfitrdt flex">
                                            <input type="checkbox" id="<?php echo strtolower($data->id); ?>" name="datanw" class="verticleMiddle filtercheckbox">
                                            <label class="checkBoxLabel robotoReguler upperCase verticleMiddle"
                                                for=""><?php echo ucwords($data->name); ?></label>
                                        </div>
                                        <?php } } ?>
                                ...
                                <div id="Neck" class="w3-container ShortFilters" style="display: none;">

                                    <div class="FebRicFilter flex">
                                         <?php 
                                         if(empty($all_fabric_nw)) { ?>
                                         <div class="maininputcheckfitrdt flex">
                                            <h3> No Data Available</h3>
                                        </div>
                                         <?php } else {  ?>
                                        <?php foreach ($all_fabric_nw as $key => $data) { ?>
                                        <div class="maininputcheckfitrdt flex">
                                            <input type="checkbox" id="<?php echo strtolower($data->id); ?>" name="new" class="verticleMiddle filtercheckbox">
                                            <label for="Denim"
                                                class="checkBoxLabel  robotoReguler upperCase verticleMiddle"
                                                for=""><?php echo ucwords($data->name); ?></label>
                                        </div>
                            ...
                            <a href="" class="robotoReguler dslctOption">Deselect All </a>
                        </div>
                    </div>
                    <!-------------------new_change_added---------------->
                    ...
                    <table class="adminTable robotoReguler newdata" cellpadding="0" cellspacing="0">
                        ...
                        <?php 
                            ...
                            <tr class="tableBdyRaw">
                              ...
                              <!------class check and input value is added is added ------------>
                                    <input type="checkbox"  class="infoInputTxt tablecheckBox txtCenter check" value="<?php echo $data->id; ?>">
                              <!-------------class check is added ------------------------------>
                                </td>
                                <td class="tblData txtCenter ">
                                <?php //echo $data->id; 
                                        echo $key + 1;
     ...
     <input type="hidden" name="fabric_typear" id="fabric_typear">
     <input type="hidden" name="fabric_datanw" id="fabric_datanw">
     <input type="hidden" name="fabric_colordata" id="fabric_colordata">
</body>
...
<script type="text/javascript">
    ...
    $('.check').on('change', function() {
        ...
        $('#archieve_allid').val(listvalues);
        //$('#archieve_allid').html(listvalues.sort());
    });
</script>
...
<script type="text/javascript">
    ...
    function archieve_allid()
    {
       var archieve_allid = $("#archieve_allid").val();
       //alert(archieve_allid); 
       $.ajax({
            url: baseurl + 'archieve_fabric_data',
            method: 'POST',
            data: {
            type: 'archieve_fabric_data', archieve_allid:archieve_allid },
...
<script type="text/javascript">
  ...
  $('.febricSeach').on('input', function() 
  
  {
     var search  = $('.febricSeach').val();
     if(search.length > 1){
     //alert(search);
     $.ajax({
            url: baseurl + 'search-fabric',
            method: 'POST',
            data: {
                type: 'search_fabric',
                search: search
            ...
            success: function(remes){
                    ...
                    var hash_id;
                    var date; var time;
                    html += '<table class="adminTable robotoReguler" cellpadding="0" cellspacing="0"><thead class="tblHead"><tr class="tableRaw tblHeadRaw robotoMedium uppercase"><th class="tblHeading upperCase"></th><th class="tblHeading upperCase">S.No.</th><th class="tblHeading upperCase">Image</th><th class="tblHeading upperCase">Fabric Code</th><th class="tblHeading upperCase">Color</th><th class="tblHeading upperCase">Vendor</th><th class="tblHeading upperCase">Store1</th><th class="tblHeading upperCase">Store2</th><th class="tblHeading upperCase">Total QTY</th><th class="tblHeading upperCase">Updated on</th></tr></thead><tbody style="overflow-y: auto;"class="catTableBody"><tr class="tableBdyRaw">'

                    if((mydata.status == true) && (mydata.data != null) )
                    {  
                       ...
                       {  
                          ...
                          fabric_code = element.fabric_code;
                          if(fabric_code == null || fabric_code == "")
                          {
                            fabric_code = 'NA';
                          }

                          info_data = element.info_data;
                          
                          if(info_data == null || info_data == "")
                          {
                            info_data = 'NA';
                          }

                          color = element.fabric_color; 
                          if(color == null || color == "")
                          {
                            color = 'NA';
                          }

                          store1 = element.store1;
                          if(store1 == null || store1 == "" || store1 == 0)
                          {
                            store1 = 'NA';
                          }

                          store2 = element.store2;
                          ...
                          if(total_qty == null || total_qty == "" || total_qty == 0)
                          {
                            total_qty = 'NA';
                          }
                          
                          datetime = element.updated_on;
                          hash_id = element.hash_data;
                          if(hash_id == null || hash_id == "")
                          {
                            html += '<td class="tblData upperCase txtCenter "><input type="checkbox" class="infoInputTxt tablecheckBox txtCenter"></td><td class="tblData upperCase txtCenter "></td><td class="tblData upperCase txtCenter "><img class="tableImg" src="images/tableImg.png" alt=""></td><td class="tblData upperCase txtCenter blueText">';
                          }
                          else
                          {
                             html += '<td class="tblData upperCase txtCenter "><input type="checkbox" class="infoInputTxt tablecheckBox txtCenter"></td><td class="tblData upperCase txtCenter "></td><td class="tblData upperCase txtCenter "><img class="tableImg" src="images/tableImg.png" alt=""></td><td class="tblData upperCase txtCenter blueText" onClick = edit_info_detail(' + hash_id + ')>';
                          }


                          date = '1';
                          time = '1';     
                          html += fabric_code + '</td><td class="tblData upperCase txtCenter ">'+ color +' </td><td class="tblData upperCase txtCenter ">' + info_data + '</td><td class="tblData upperCase txtCenter ">'+ store1 +'</td><td class="tblData upperCase txtCenter ">'+ store2 +'</td><td class="tblData upperCase txtCenter ">'+ total_qty +'</td><td class="tblData upperCase txtCenter robotoReguler">'+ datetime +'</td>';     
                       });
                       

                       html += '</tr></tbody> </tbody></table>';
                       $("#alldata").append(html);
                    ...
                    {   
                        ...
                        var html_data;
                        html_data += ' <table class="adminTable robotoReguler newdata" cellpadding="0" cellspacing="0"><thead class="tblHead"><tr class="tableRaw tblHeadRaw robotoMedium uppercase"><th class="tblHeading upperCase"></th><th class="tblHeading upperCase">S.No.</th><th class="tblHeading upperCase">Image</th><th class="tblHeading upperCase">Fabric Code</th><th class="tblHeading upperCase">Color</th><th class="tblHeading upperCase">Vendor</th><th class="tblHeading upperCase">Store1</th><th class="tblHeading upperCase">Store2</th><th class="tblHeading upperCase">Total QTY</th><th class="tblHeading upperCase">Updated on</th></tr></thead><tbody style="overflow-y: auto;" class="catTableBody"><tr class="tableBdyRaw"><td class="tblData upperCase txtCenter" style="padding: 61px 0 61px !important;"><h3 style="color:#4766ae;">No Results Found</h3></td></tr></tbody></table>';
                        
                        $("#data_not_found").append(html_data);
...
<script>
        // ============================//fabric length neck============================//
        function openShortFilters(ShortFiltersName) {
            var i;
            var x = document.getElementsByClassName("ShortFilters");
            for (i = 0; i < x.length; i++) {
                x[i].style.display = "none";
            }
            document.getElementById(ShortFiltersName).style.display = "block";
        }
    </script>
    <script>
    function searchFilter(page_num) {
        ...
        $.ajax({
            type: 'POST',
            url: 'https://inventory.deebaco.com/index.php/getdata_all',
   ...
   <script type="text/javascript">
       $(':checkbox[name=new]').on('change', function() 
       {
         var assignedTo = $(':checkbox[name=new]:checked').map(function() {
         return this.id;
        }).get();
       //console.log(JSON.stringify(assignedTo));
       $('#fabric_typear').val(JSON.stringify(assignedTo));
       var fabrictypedata = $('#fabric_typear').val();
       var fabric_datanw = $('#fabric_datanw').val();
       var fabric_colordata = $('#fabric_colordata').val();

       $.ajax({
            type: 'POST',
            url: 'https://inventory.deebaco.com/index.php/getdata_alldata',
            data:'fabrictypedata='+fabrictypedata+'&fabric_datanw='+fabric_datanw+'&fabric_colordata='+fabric_colordata,
            beforeSend: function () {
                $('.loading-overlay').show();
            },
            success: function (html) {
   ...
   <script type="text/javascript">
       $(':checkbox[name=datanw]').on('change', function() 
       {
         var nw = $(':checkbox[name=datanw]:checked').map(function() {
         return this.id;
        }).get();
       //console.log(JSON.stringify(assignedTo));
       $('#fabric_datanw').val(JSON.stringify(nw));
       ...
       $.ajax({
            type: 'POST',
            url: 'https://inventory.deebaco.com/index.php/getdata_alldata_getdata_url',
            data:'fabrictypedata='+fabrictypedata+'&fabric_datanw='+fabric_datanw+'&fabric_colordata='+fabric_colordata,
            beforeSend: function () {
                $('.loading-overlay').show();
            },
   ...
   <script type="text/javascript">
       $(':checkbox[name=nw]').on('change', function() 
       {
         var nwdata = $(':checkbox[name=nw]:checked').map(function() {
         return this.id;
        }).get();
       //console.log(JSON.stringify(assignedTo));
       $('#fabric_colordata').val(JSON.stringify(nwdata));
       ...
       $.ajax({
            type: 'POST',
            url: 'https://inventory.deebaco.com/index.php/getdata_alldata_getdata_alldata',
            data:'fabrictypedata='+fabrictypedata+'&fabric_datanw='+fabric_datanw+'&fabric_colordata='+fabric_colordata,
            beforeSend: function () {
                $('.loading-overlay').show();
            },
