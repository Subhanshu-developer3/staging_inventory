        ...
        <div class="mainContentSection flex">
            ...
            <div class="mainRight">
                <div class="flex tabViewBtns robotoReguler">
                    <a href="#" class="btn upperCase tabViewBtn whiteBack">basic Info</a>
                    <a href="#" class="btn upperCase tabViewBtn whiteBack">Inventory Details</a>
                   <a href="javascript:void(0)" class="btn upperCase tabViewBtn blueBtn ">Vendor Details</a>
                </div>
                <!-- ===================information=================== -->
                <form method="post" action="<?php echo base_url(); ?>add-cvendor-detail/<?php echo $url; ?>">
                    <div class="mainBasicInfoSection backgroundWhite flex alignCenter">
                        <div class="addVendor">
                            <input type="hidden" name="url" id="url" value="<?php echo $url; ?>">
                            <input type="hidden" name="id" id="id" value="<?php echo $id;?>">
                            <input type="submit" class="saveBtn upperCase blueBtn btn" value="Add Vendor" href="javascript:void(0)">
                        </div>
                    </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function add_new_cvendor()
    {
            var baseurl = 'https://inventory.deebaco.com/index.php/';
            var id = $("#id").val();
            var url = $("#url").val();
            //alert(baseurl+"add-cvendor-detail/"+url);
            //window.location = baseurl+"add-cvendor-detail/"+url;
