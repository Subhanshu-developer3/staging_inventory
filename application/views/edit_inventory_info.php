...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="https://inventory.deebaco.com/inventory_assets/style/style.css" />
   </head>
   <body>
      ...
      <div class="header flex">
         <div class="logo">
            <img src="https://inventory.deebaco.com/inventory_assets/images/logo.png" alt="" />
         </div>
         <div class="headerIcons flex">
            <a href="#" class="HeaderIcon headerBell">
            <img src="https://inventory.deebaco.com/inventory_assets/images/notification_icon.png" alt="">
            </a>
            <a href="#" class="HeaderIcon HeaderUser">
            <img src="https://inventory.deebaco.com/inventory_assets/images/user_login.png" alt="">
            </a>
         </div>
      </div>
      ...
      <div class="mainContentSection flex">
         ...
         <div class="mainLeft">
           <ul class="sidebarMenu robotoReguler">
               ...
               <li class="SidemenuItem upperCase"><a href="javascript:void(0)">Inventory</a></li>
               <li class="SidemenuItem upperCase"><a href="javascript:void(0)">Trims</a></li>
               <li class="SidemenuItem upperCase"><a href="javascript:void(0)"> Vendor Management</a></li>
         ...
         <div class="mainRight">
            <div class="flex tabViewBtns robotoReguler">
               <a href="javascript:void(0)" class="btn upperCase tabViewBtn blueBtn upperCase">basic Info</a>
               <a href="javascript:void(0)" onclick="showcvendornwdata('<?php echo $url; ?>')" class="btn upperCase tabViewBtn whiteBack">Vendor Details</a>
            </div>
            <!-- ===================information=================== -->
            <form action="">
               <div class="mainBasicInfoSection">
                  <div class="information section inventoryDetail">
                     <div class="flex mainInfoInputS robotoReguler BasicInfoInformaiotn">
                        <div class="back-arrow flex">
                           


                           <a href="javascript:void(0)" onclick="inventory_redirectbasic('<?php echo $url; ?>')"> <img src="https://inventory.deebaco.com/inventory_assets/images/back-arrow.png" alt=""> </a>

                           <a href="javascript:void(0)" onclick="nwinventory('<?php echo $url; ?>','<?php echo $dataid; ?>')"><img src="https://inventory.deebaco.com/inventory_assets/images/edit_icon.png" alt=""></a>
                        </div>
                     </div>
                  </div>
                  <div class="defects section">
                     ...
                     <p class="heading robotoMedium upperCase">Defetcs <span class="blueClr italic">(If
                        Yes)</span>
                     </p>
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel1 labelTitle">Defect Type</label>
                           <div class="requiredmsg infoInput10 flex flexWrap">
                              <input type="text" id="defect_type" class="infoInputTxt upperCase completeWidth" placeholder=" " value="<?php echo $alldata[0]->defect_type; ?>" disabled="true" style="cursor: not-allowed;">
                           </div>
                        </div>
                        <div class="maininfoInput1 inputSelectbtn upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel13 labelTitle">Defect QTY</label>
                           <div class="inpuSltBtn flex">
                              <input type="text"  id="defect_qty"  class="infoInputTxt upperCase infoInput12 inputSltlft" value="<?php echo $alldata[0]->defect_qty; ?>"  disabled="true" style="cursor: not-allowed;">
                              <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18 febricInventoryinput febricInventoryselect  defectQtySelect" id="defect_qty_unit"   name="defect_qty_unit" 
                              disabled="true" style="cursor: not-allowed;">
                                  <!-- <option value="" disabled selected hidden class="febricType">select Color</option> -->
                                   <?php  
                                  if(!empty($all_unit)){
                                  foreach ($all_unit as $aldata)
                                  { ?>
                                  <?php echo $aldata->id; ?>
                                  <option value="<?php echo $aldata->id; ?>" 
                                     <?php 
                                        if($aldata->id == $alldata[0]->defect_qty_unit) { 
                                        echo "selected"; 
                                        } ?> 
                                   class="febricType"><?php echo $aldata->name; ?></option> 
                              
                                  <?php } } ?>
                              </select>
                           </div>
                        </div>
                        <div class="maininfoInput11 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel3 labelTitle">Defect
                           Remarks</label>
                           <div class="requiredmsg infoInput11 flex flexWrap">
                              <textarea  disabled="true" style="cursor: not-allowed;" id="defect_remarks" class="infoInputTxt defctsTxtArea upperCase completeWidth"><?php echo $alldata[0]->defect_remarks; ?> </textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="colorBleed section">
                     <p class="heading robotoMedium upperCase">Color Bleed</p>
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel12 labelTitle">With Water</label>
                           <div class="YEsNoBtns flex">

                               <?php 
                                     if(!empty($alldata[0]->with_water_response))
                                     {  
                                      

                                     $status0 = strlen($alldata[0]->with_water_response);
                                     if($status0 == 2)
                                     { ?>
                                       <a href="javascript:void(0)" onclick="with_water(true)" id=" with_water" class="btn bleedBtn activeBlueBtn"
                                       style="cursor:not-allowed;" disabled="true">Yes</a>
                                       <a href="javascript:void(0)" onclick="with_water(false)" id="with_water_re" class="btn bleedBtn"
                                       style="cursor:not-allowed;" disabled="true">No</a>
                                     <?php } else {  ?>

                                        <a href="javascript:void(0)" onclick="with_water(true)" id="with_water" class="btn bleedBtn" 
                                        style="cursor:not-allowed;" disabled="true">Yes</a>
                                        <a href="javascript:void(0)" onclick="with_water(false)" id="with_water_re" class="btn bleedBtn activeBlueBtn"
                                        style="cursor:not-allowed;" disabled="true">No</a>
                                     ...
                                     <?php } ?>
                                      ...
                                      <input type="hidden" id="with_water_response" value="<?php 
                                      if(empty($alldata[0]->with_water_response))
                                      { }
                                      else
                                      { if($alldata[0]->with_water_response === 'on')
                                      { echo 'on'; } else { echo 'off'; } }?>">
                           </div>
                        </div>
                        <div class="maininfoInput13 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel13 labelTitle">With Soap</label>
                           <div class="YEsNoBtns YEsNoBtns1 flex">

                           <?php 

                               if(!empty($alldata[0]->with_soap_response))
                               {  
                               


                               $status1 = strlen($alldata[0]->with_soap_response);
                               if($status1 == 2)
                               { ?>
                                    <a href="javascript:void(0)" onclick="with_soap_re(true)" id="with_soap_re_true" class="btn bleedBtn activeBlueBtn" style="cursor:not-allowed;" disabled="true">Yes</a>
                                    <a href="javascript:void(0)" onclick="with_soap_re(false)" id="with_soap_re_false" class="btn bleedBtn" style="cursor:not-allowed;" disabled="true">No</a>

                                <?php } else { ?>
                                   <a href="javascript:void(0)" onclick="with_soap_re(true)" id="with_soap_re_true" class="btn bleedBtn" 
                                   style="cursor:not-allowed;" disabled="true">Yes</a>
                                   <a href="javascript:void(0)" onclick="with_soap_re(false)" id="with_soap_re_false" class="btn bleedBtn activeBlueBtn" style="cursor:not-allowed;" disabled="true">No</a>
                               <?php } } else { ?>
                                   <a href="javascript:void(0)" onclick="with_soap_re(true)" id="with_soap_re_true" class="btn bleedBtn" 
                                   style="cursor:not-allowed;" disabled="true">Yes</a>
                                   <a href="javascript:void(0)" onclick="with_soap_re(false)" id="with_soap_re_false" class="btn bleedBtn activeBlueBtn"
                                   style="cursor:not-allowed;" disabled="true">No</a>
                                <?php } ?>

                                 <input type="hidden" id="with_soap_response" value="<?php 
                                        if(!empty($alldata[0]->with_soap_response)){

                                        if($alldata[0]->with_soap_response === 'on')
                                            { echo 'on'; } else { echo 'off'; }

                                        } else {} ?>">
                           </div>
                        </div>
                        <div class="maininfoInput14 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel14 labelTitle">Comments</label>
                           <div class="basicTxtArea">
                             <textarea id="colorbleed_comments" row="3" col="4"class="infoInputTxt lacesinputTxtArea upperCase infoInput14" style="cursor:not-allowed;" disabled="true"> <?php echo $alldata[0]->colorbleed_comments; ?></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="shirnkage section">
                     <p class="heading robotoMedium upperCase">Shrinkage <span class="blueClr italic">(If
                        Yes)</span>
                     </p>
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 TitleInputBox upperCase flex">
                            <label for="Fabric Code" class="infoInputLabel12 labelTitle">Before test</label>
                                  <input type="text" id="shrinkage_before_test_h" oninput="shrinkage_nah()" class="infoInputTxt upperCase infoInput12" 
                                     value="<?php if(empty($alldata[0]->shrinkage_before_test_h)){}else{ echo $alldata[0]->shrinkage_before_test_h;} ?>"
                                     style="cursor:not-allowed;" disabled="true"
                                  /><span class="hightwidthlabl">H</span>
                                 <input type="text" id="shrinkage_before_test_w" oninput="shrinkage_naw()" class="infoInputTxt upperCase infoInput12"
                                     value="<?php if(empty($alldata[0]->shrinkage_before_test_w)){}else{ echo $alldata[0]->shrinkage_before_test_w;} ?>"  
                                     style="cursor:not-allowed;" disabled="true" /><span class="hightwidthlabl">w</span>
                        </div>
                        <div class="maininfoInput13 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel13 labelTitle">After test</label>
                              
                                 <input type="text" id="shrinkage_fabric_code_h" oninput="shrinkage_codeh()" class="infoInputTxt upperCase infoInput13"  
                                    value="<?php if(empty($alldata[0]->shrinkage_fabric_code_h)){}else{ echo $alldata[0]->shrinkage_fabric_code_h;} ?>"  style="cursor:not-allowed;" disabled="true"/>
                                 <span class="hightwidthlabl">H</span>
                                 <input type="text" id="shrinkage_fabric_code_w" oninput="shrinkage_codew()" class="infoInputTxt upperCase infoInput13" 
                                    value="<?php if(empty($alldata[0]->shrinkage_fabric_code_w)){}else{ echo $alldata[0]->shrinkage_fabric_code_w;} ?>"  style="cursor:not-allowed;" disabled="true"
                                 /><span class="hightwidthlabl">w</span>
                           
                        </div>
                        <div class="maininfoInput14 upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel14 labelTitle">After Shrinkage Qty</label>
                            <input type="text" style="height: 36px;" class="infoInputTxt upperCase infoInput12" placeholder="" name="after_shrinkage_qty" id="after_shrinkage_qty" value="<?php if(empty($alldata[0]->after_shrinkage_qty)){}else{ echo $alldata[0]->after_shrinkage_qty;} ?>"  style="cursor:not-allowed;" disabled="true">
                               
                           <div class="requiredmsg infoInput12 flex flexWrap">
                              <select type="text" class="infoInputTxt upperCase  completeWidth defectQtyShrinkage" name="after_shrinkage_qtyunits" 
                              id="after_shrinkage_qtyunits" style="cursor:not-allowed;width:62px;" disabled="true">
                                  ...
                                  <option value="<?php echo $aldata->id; ?>" 
                                     <?php 
                                        if($aldata->id == $alldata[0]->after_shrinkage_qtyunits) { 
                                        echo "selected"; 
                                        } ?> 
                                   class="febricType"><?php echo $aldata->name; ?></option> 
                        ...
                        <div class="maininfofullText TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel labelTitle">Comments</label>
                           <div class="basicTxtArea">
                                 <textarea id="shrinkage_comments" row="3" col="4" class="infoInputTxt lacesinputTxtArea upperCase infoInput14" style="cursor:not-allowed;" disabled="true"><?php if(empty($alldata[0]->shrinkage_comments)){}else{ echo $alldata[0]->shrinkage_comments;} ?></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="return section">
                     <p class="heading robotoMedium upperCase">Return <span class="blueClr italic">(If
                        Yes)</span>
                     </p>
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel12 labelTitle">Return QTY</label>
                           <div class="inpuSltBtn flex">
                              <input type="text" id="return_qty" name="return_qty" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder="" value="<?php if(empty($alldata[0]->return_qty)){}else{ echo $alldata[0]->return_qty; }?>" 
                              style="cursor:not-allowed;" disabled="true"/>
                              <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="retnqtyunit1" id="retnqtyunit1" style="cursor:not-allowed;width:83px;" disabled="true">
                                 <option value="" disabled selected hidden class="febricType" >select </option>
                                  <?php  
                                  if(!empty($all_unit)){
                                  foreach ($all_unit as $aldata)
                                  { ?>
                                  ...
                                  <option value="<?php echo $aldata->id; ?>" 
                                     <?php 
                                        if($aldata->id == $alldata[0]->return_qty_unit) { 
                                        echo "selected"; 
                                        } ?> 
                                   class="febricType"><?php echo $aldata->name; ?></option> 
                              
                                  <?php } } ?>
                                  <p class="errorMsg dataerror_store1" style="display:none;">This field is invalid</p>
                              </select>
                           </div>
                        </div>
                        <div class="maininfoInput13 inputSelectbtn upperCase flex">
                           <label for="Fabric Code" class="infoInput15 labelTitle calDate">Return Date</label>
                           <!-- <input type="text" class="infoInputTxt upperCase width40 inputSltlft" placeholder="04-Jan-2022"> -->
                           <input type="text" id="return_date" name="return_date" class="infoInputTxt upperCase width40 " placeholder="04-Jan-2022"  value="<?php 
                                            if(empty($alldata[0]->return_date)){}else{ echo $alldata[0]->return_date; }?>" style="cursor:not-allowed;" disabled="true"/>

                           <!-- <div class="lefSideWidth flex popRupeesBox inputSltrgt width18">
                              <a href=""><img src="<?php echo base_url(); ?>/inventory_assets/images/calendar.png" alt="" class=""></a>
                           </div> -->
                        </div>
                        <div class="maininfoInput14 upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel12 labelTitle">return reason</label>
                           <div class="basicTxtArea">
                              <textarea type="textarea" id="return_reason" row="3" col="4" name="return_reason" class="infoInputTxt lacesinputTxtArea upperCase TitleInputBox infoInput11" style="cursor:not-allowed;" disabled="true"/><?php if(empty($alldata[0]->return_reason)){}else{ echo $alldata[0]->return_reason; }?></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="fabric-Qty section">
                     <p class="heading robotoMedium upperCase">Fabric QTY
                     </p>
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel12 labelTitle">Total QTY</label>
                           <div class="inpuSltBtn flex">
                             
                           <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder=""  name="data_total_fabric_qty_data_1"   id="data_total_fabric_qty_data_1" oninput="data_total_fabric_qty_data_1_new()"
                           value="<?php if(empty($alldata[0]->total_qty)){ echo "0"; }else{ echo $alldata[0]->total_qty; }?>" style="cursor:not-allowed;width:36%;" disabled="true">
                           
                              <select type="text" class="infoInputTxt upperCase febricInventoryinput febricInventoryselect " name="data_totalQtyunit_data_1" id="data_totalQtyunit_data_1" onchange="newdataqtyunit()" style="cursor:not-allowed;width:63px;" disabled="true">
                                 <!-- <option value="" class="febricType" disabled="" selected="" hidden="">Select Unit
                                 </option> -->
                                  ...
                                  <option value="<?php echo $aldata->id; ?>" 
                                     <?php 
                                        if($aldata->id == $alldata[0]->total_qty_unit) { 
                                        echo "selected"; 
                                        } ?> 
                                   class="febricType"><?php echo $aldata->name; ?></option> 
                                  ...
                                  <?php } } ?>
                                            ...
                                            <p class="errorMsg data_error_newerrorall_1" style="display:none;">* This feild is invalid</p>
                                            <p class="errorMsg data_error_totalqty" style="display:none;">Total quantity must be a valid number greater than zero unit</p>
                                            <p class="errorMsg data_error_totalqty_store1" style="display:none;">Total quantity in store1 will have to be exactly or less than total quantity entered</p>
                                            <p class="errorMsg data_error_totalqty_store2" style="display:none;">Total quantity in store2 will have to be exactly or less than total quantity entered</p>
                                            <p class="errorMsg data_error_totalqty_store12" style="display:none;">Aggregate quantity in store1 and store2 will have to be exactly or less than total quantity entered</p>

                                            <p class="errorMsg data_error_totalqty0" style="display:none;">si unit didn't match with store1 unit</p>
                                             <p class="errorMsg data_error_totalqty1" style="display:none;">si unit didn't match with store2 unit</p>


                           </div>
                        </div>
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel12 labelTitle">Fabric Width</label>
                           <div class="inpuSltBtn flex">
                               <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder="" name="data_fabric_width_data_1" id="data_fabric_width_data_1" oninput="fabric_width_datanwerror()"
                               value="<?php if(empty($alldata[0]->fabric_width)){}else{ echo $alldata[0]->fabric_width; }?>" style="cursor:not-allowed;width:99px;" disabled="true">
                               
                                <select  class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="data_fabricWidthunit_data_1" id="data_fabricWidthunit_data_1" 
                                 style="cursor:not-allowed;width:88px;" disabled="true">
                                 ...
                                 <?php  
                                  ...
                                  <option value="<?php echo $aldata->id; ?>" 
                                     <?php 
                                        if($aldata->id == $alldata[0]->fabric_width_unit) { 
                                        echo "selected"; 
                                        } ?> 
                                   class="febricType"><?php echo $aldata->name; ?></option> 
                                  ...
                                  <?php } } ?>
                                             ...
                                             <p class="errorMsg dataerror_fabricwidth" style="display:none;">This field is invalid</p>
                                             <p class="errorMsg dataerror_fabricwidth_1" style="display:none;">* This field is invalid</p>
                           </div>
                        </div>
                        <div class="maininfoInput1 inputSelectbtn  TitleInputBox upperCase flex">
                           <div class="flex">
                              <label for="Fabric Code" class="infoInput15 labelTitle">Date</label>
                              <input type="text" class="infoInputTxt upperCase infoInput1 inputSltlft" placeholder="04-Jan-2022" name="data_fabric_date_data_1" id="data_fabric_date_data_1" oninput="fabric_date_datanwerror()" 
                              value="<?php if(empty($alldata[0]->data_fabric_date_data_1)){}else{ echo $alldata[0]->data_fabric_date_data_1; }?>" style="cursor:not-allowed;width:178px;" disabled="true">
                               <p class="errorMsg dataerror_fabricdate_1" style="display:none;">* This field is invalid</p>
                              <!-- <div class="lefSideWidth flex popRupeesBox  inputSltrgt width18">
                                 <a href=""><img src="<?php echo base_url(); ?>/inventory_assets/images/calendar.png" alt="" class=""></a>
                              </div> -->
                           </div>
                  ...
                  <div class="store-Qty section">
                     <p class="heading robotoMedium upperCase">Store QTY
                     </p>
                     <div class="flex mainInfoInputS robotoReguler ">
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           <div class="storeBox flex">
                              <label for="Fabric Code" class="infoInputLabel12 labelTitle">Store 1</label>
                              <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft placeholder="  oninput="add_qtynewdata()" id="store1" name="store1" value="<?php if(empty($alldata[0]->store1)){ echo '0'; }else{ echo $alldata[0]->store1; }?>" style="cursor:not-allowed;" disabled="true">

                              <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="storeunit1" id="storeunit1"  onchange="data_storeunit1()" style="cursor:not-allowed;" disabled="true">
                                 <!-- <option value="" class="febricType" disabled="" selected="" hidden="">MM
                                 </option> -->
                                 <!-- <option value="" disabled selected hidden class="FabricPattern">Select Unit</option> -->
                                 ...
                                 <?php  
                                  ...
                                  <option value="<?php echo $aldata->id; ?>" 
                                     <?php 
                                        if($aldata->id == $alldata[0]->storeunit1) { 
                                        echo "selected"; 
                                        } ?> 
                                   class="febricType"><?php echo $aldata->name; ?></option> 
                           ...
                           <span class="lotNothlabl">LOT No.</span>
                             <input type="text" id="lotno1" name="lotno1" class="infoInputTxt upperCase infoInput12 lotNoinput" placeholder="" oninput="dataerrorlotno1()" value="<?php if(empty($alldata[0]->store1)){ echo '0'; }else{ echo $alldata[0]->lotno1; }?>" style="cursor:not-allowed;" disabled="true"/> 
                             <p class="errorMsg" id="lotno1_error" style="display:none;">This field is required</p>
                        </div>
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           <div class="storeBox flex">
                              <label for="Fabric Code" class="infoInputLabel12 labelTitle">Store 2</label>
                     
                           <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder=""  id="store2" name="store2" oninput="add_qty()" 

                           value="<?php if(empty($alldata[0]->store2)){ echo '0'; }else{ echo $alldata[0]->store2; }?>" style="cursor:not-allowed;" disabled="true">

                           <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="storeunit2" id="storeunit2" onClick="data_storeunit2()" style="cursor:not-allowed;" disabled="true">
                                 <!-- <option value="" class="febricType" disabled="" selected="" hidden="">MM
                                 </option> -->
                                 <!-- <option value="" disabled selected hidden class="FabricPattern">Select Unit</option> -->
                                 ...
                                 <?php  
                                  ...
                                  <option value="<?php echo $aldata->id; ?>" 
                                     <?php 
                                        if($aldata->id == $alldata[0]->storeunit2) { 
                                        echo "selected"; 
                                        } ?> 
                                   class="febricType"><?php echo $aldata->name; ?></option> 
                           ...
                           <span class="lotNothlabl">LOT No.</span>
                           <input type="text" id="lotno2" name="lotno2"  class="infoInputTxt upperCase infoInput12 lotNoinput" placeholder=""  oninput="dataerrorlotno2()"      value="<?php if(empty($alldata[0]->store2)){ echo '0'; }else{ echo $alldata[0]->lotno2; }?>" style="cursor:not-allowed;" disabled="true"/>
                           <p class="errorMsg" id="lotno2_error" style="display:none;">This field is required</p>

                        </div>
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           <div class="storeBox flex">
                              <label for="Fabric Code" class="infoInputLabel12 labelTitle">Total QTY.</label>
                              <?php if(!empty($alldata[0]->total_qty_unit)) 
                                    { 
                                        $return = $this->Crud_model->fetchalldatawithcondition('units', 'id', $alldata[0]->total_qty_unit);
                                        $nw = $return[0]->name;
;                                    }
                                    else
                                    {
                              ...
                              <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder=" " id="total_qty" name="total_qty" disabled="true" style="cursor:not-allowed;" value="<?php if(empty($alldata[0]->storetotal_qty)){ echo '0'; }else{ echo $alldata[0]->storetotal_qty; }?>">
                              <input class="infoInputTxt upperCase infoInput12 inputSltlft total_qtyunit" name="total_qtyunit" id="total_qtyunit" value="<?php echo $nw; ?>" style="cursor: not-allowed;" readonly="">
 
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="fnsGoods section">
                     <p class="heading robotoMedium upperCase"> Finished goods </p>
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput14 upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel13 labelTitle">SKU</label>

                            <?php if(empty($alldata[0]->add_sku_no_1)){ ?>
                           <div class="requiredmsg infoInput10 flex flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth"  placeholder="" name="add_sku_no_1" id="add_sku_no_1">
                             <!--  <a href="javascript:void(0)" class="deleteSku blueBtn" id="delete_sku_1" onClick="deleteaSku(1)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="<?php echo base_url();?>SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a> -->
                           </div>
                           <?php } else { ?> 
                           ...
                           <div class="requiredmsg infoInput10 flex flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth"  placeholder="" name="add_sku_no_1" id="add_sku_no_1"   
                              value="<?php if(empty($alldata[0]->add_sku_no_1)){  }else{ echo $alldata[0]->add_sku_no_1; }?>" style="cursor:not-allowed;width:138px;" disabled="true">
                              <!-- <a href="javascript:void(0)" class="deleteSku blueBtn" id="delete_sku_1" onClick="deleteaSku(1)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="<?php echo base_url();?>SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                           ...
                           <?php if((!empty($alldata[0]->add_sku_no_2))){ ?>
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth TitleInputBox" name="add_sku_no_2"  id="add_sku_no_2" 
                              value="<?php if(empty($alldata[0]->add_sku_no_2)){  }else{ echo $alldata[0]->add_sku_no_2; }?>" style="cursor:not-allowed;width:138px;" disabled="true">
                              <!-- <a href="javascript:void(0)" style="display: none;" class="deleteSku blueBtn"  id="delete_sku_2" onClick="deleteaSku(2)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="<?php echo base_url();?>SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a> -->
                          ...
                          <?php } ?>
                           ...
                           <?php if((!empty($alldata[0]->add_sku_no_3))){ ?>
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth TitleInputBox" name="add_sku_no_3"  id="add_sku_no_3"
                              value="<?php if(empty($alldata[0]->add_sku_no_3)){  }else{ echo $alldata[0]->add_sku_no_3; }?>" style="cursor:not-allowed;width:138px;" disabled="true">
                              <!-- <a href="javascript:void(0)" style="display: none;" class="deleteSku blueBtn"  id="delete_sku_3" onClick="deleteaSku(3)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="<?php echo base_url();?>SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a> -->
                           ...
                           <?php if((!empty($alldata[0]->add_sku_no_4))){ ?>
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth TitleInputBox" name="add_sku_no_4" id="add_sku_no_4"
                              value="<?php if(empty($alldata[0]->add_sku_no_4)){  }else{ echo $alldata[0]->add_sku_no_4; }?>" style="cursor:not-allowed;width:138px;" disabled="true">
                              <!-- <a href="javascript:void(0)" class="deleteSku blueBtn" style="display: none;"  id="delete_sku_4" onClick="deleteaSku(4)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="<?php echo base_url();?>SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a> -->
                           ...
                           <?php if((!empty($alldata[0]->add_sku_no_5))){ ?>
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth TitleInputBox" name="add_sku_no_5" id="add_sku_no_5"
                               value="<?php if(empty($alldata[0]->add_sku_no_5)){  }else{ echo $alldata[0]->add_sku_no_5; }?>" style="cursor:not-allowed;width:138px;" disabled="true" >
                             <!--  <a href="javascript:void(0)" class="deleteSku blueBtn" style="display: none;" id="delete_sku_5" onClick="deleteaSku(5)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="<?php echo base_url();?>SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a> -->
                             ...
                             <!--  <a href="javascript:void(0)" class="addSku"id="addSku"  onClick="addaSku()">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen addSkuIcon">
                                                <use xlink:href="<?php echo base_url();?>SVG/sprite.svg#icon-plus"></use>
                                            </svg>
                              </a> -->
                              <input type="hidden" id="addskuCount" name="addskuCount" value="1">
                           </div>
                           <?php } ?>

                        </div>
                        <!-- <div class="maininfoInput10 upperCase flex">
                           <a href=""><img src="<?php echo base_url(); ?>/inventory_assets/images/deletBtn.png" alt="" class="SkuInput"></a>
                           <a href=""><img src="<?php echo base_url(); ?>/inventory_assets/images/addBtn.png" alt="" class="SkuInput "></a>
                        </div> -->
                     </div>
                  </div>
                  ...
                  <!-------------------------------------------------------------------------->
                  <input type="hidden" name="totalqtyleftnaew" id="totalqtyleftnaew" value="0"> 
                  <input type="hidden" name="total_qtyunitvalue" id="total_qtyunitvalue" class="total_qtyunitvalue" value="0">
                  <input type="hidden" name="fabric_codeid" id="fabric_codeid" value="<?php echo $id; ?>">
                  <input type="hidden" name="fabricpurchaseid" id="fabricpurchaseid" value="<?php echo $dataid; ?>">
                  <input type="hidden" name="hash_id" id="hash_id"  value="<?php echo $url; ?>">

                  <input type="hidden" name="inventory_id" id="inventory_id" value="<?php echo $alldata[0]->id; ?>">
                  <input type="hidden" name="remain_qty" id="remain_qty" value="<?php echo $alldata[0]->remain_qty; ?>">
                  <!--------------------------------------------------------------------------> 

                  


                  <div class="invenorySaveBtn">
                     <div class="minSaveBtn flex">
                        <input type="button" class="saveBtn upperCase blueBtn btn" value="SAVE"  onClick="add_inventory_detail()" href="javascript:void(0)"  style="display:none;">
                     </div>
                  </div>
                  ...
                  <div class="filterBtn section">
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput2 inputSelectbtn upperCase flex">
                           <select type="text" class="infoInputTxt monthBox upperCase infoInput13">
                              <option value="" class="febricType" disabled="" selected="" hidden="">October
                              </option>
                              <option value="" class="febricType">January</option>
                              <option value="" class="febricType">February</option>
                              <option value="" class="febricType">March</option>
                              <option value="" class="febricType">April</option>
                              <option value="" class="febricType">May</option>
                           </select>
                           <select type="text" class="infoInputTxt upperCase infoInput12 ">
                              <option value="" class="febricType" disabled="" selected="" hidden="">2020
                              </option>
                              <option value="" class="febricType">2021</option>
                              <option value="" class="febricType">2022</option>
                              <option value="" class="febricType">2023</option>
                              <option value="" class="febricType">2024</option>
                              <option value="" class="febricType">2025</option>
                           </select>
                           <a href=""><img src="https://inventory.deebaco.com/inventory_assets/images/filter-data-btn.png" alt="" class=""></a>
                        </div>
                        ...
                        <div class="filterTbl">
                        <?php 
                        if((!empty($all_records_data)) || ($all_records_data != 0))
                        {
                        foreach ($all_records_data as $key => $nwdata) 
                        {
                           $date =  $nwdata->date; 
                           $in =    $nwdata->record_in;
                           $recordin_units = $nwdata->recordin_units;
                           $out =   $nwdata->record_out;
                           $recordouta_units = $nwdata->recordouta_units; 
                           //$total_qty_lefta_units = $nwdata->total_qty_lefta_units; 
                           $storeqty =  $nwdata->storeqty; 
                           $skurecord = $nwdata->skurecord;
                           $total_qty_left =  $nwdata->total_qty_left;
                           $enter =  $nwdata->enter; 
                           $key = $key + 1;
                          ?>
                          ...
                          <?php  
                                  ...
                                  $datanew = $this->Crud_model->fetchalldatawithcondition('fabric_temporary_data', 'record_slug0', $hash_id); 
       
                                  if(!empty($datanew[0]))
                                  {
                                    $idnew = $datanew[0];  
                                    $fabric_code_id = $idnew->id; 
                                  }  
    
    
                                  $fabricpurchaseid = $this->uri->segment(3);  
                                  $return = $this->Crud_model->fetchtabledatatwo('inventory','fabric_codeid',$fabric_code_id,'fabricpurchaseid',$fabricpurchaseid);
                                  $total_qty_lefta_units = $return[0]->total_qty_unit;
                              ?>
                              
                           <div class="tblRow" id="FullDateYear_<?php echo $key; ?>">
                              <div class=" tableGrayBox">
                                 <div class="maininfoInput9 inputSelectbtn upperCase flex">
                                    <div class="flex">
                                       <label for="Fabric Code" class="infoInputLabel13 labelTitle">Date</label>
                                       <input type="date" class="infoInputTxt upperCase infoInput4 inputSltlft data_date_<?php echo $key; ?>" name="date_<?php echo $key; ?>" id="date_<?php echo $key; ?>" placeholder=""
                                       value="<?php echo $date; ?>" style="width: 69%; cursor:not-allowed;width:138px;" readonly>




                                       <p class="errorMsg dataerr_date_<?php echo $key; ?>" style="color:#dc3545;display:none;">* This field is invalid</p>
                                       <!-- <div class="lefSideWidth flex popRupeesBox  inputSltrgt width18">
                                          <a href=""><img src="<?php echo base_url(); ?>/inventory_assets/images/calendar.png" alt="" class=""></a>
                                       </div> -->
                                    </div>
                                 </div>
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" style="margin-left:16px;">IN &nbsp;</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="in_<?php echo $key; ?>" id="in_<?php echo $key; ?>" value="<?php echo $in; ?>" style="cursor:not-allowed;width:99px;" readonly>
                                      <!-- <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" id="recordin_units_<?php //echo $key; ?>"   name="recordin_units_<?php //echo $key; ?>" disabled="true" style="cursor: not-allowed;width:60px;">
                                        
                                       </select> -->
                                    </div>
                                 </div>
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" style="margin-left: 10px;">OUT</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="out_<?php echo $key; ?>" id="out_<?php echo $key; ?>" id="out_data" value="<?php echo $out; ?>" style="cursor:not-allowed;width:99px;" readonly>
                                       <!--<select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" id="recordouta_units_<?php echo $key; ?>"   name="recordouta_units_<?php echo $key; ?>" disabled="true" style="cursor: not-allowed;width:58px;"> 
                                        
                                       </select>-->
                                    </div>

                                    <p class="errorMsg" id="outerr_outerror_out_<?php echo $key; ?>" style="color:#dc3545; display:none;">* This field is invalid</p>

                                    <p class="errorMsg" id="lotno1_outerrorstore1_out_<?php echo $key; ?>" style="display:none;">* Total quantity must be a valid number less than and equal to quantity in store 1</p>
                                    
                                    <p class="errorMsg" id="lotno2_outerrorstore2_out_<?php echo $key; ?>" style="display:none;">Total quantity must be a valid number less than and equal to quantity in store 2</p>

                                 </div>
                                 <div class="maininfoInput5 upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" style="margin-left: 6px;" >Store</label>
                                    <div class="requiredmsg infoInput1 flex flexWrap">
                                      
                                       <select type="text" class="infoInputTxt"        style="width: 140px;"
                                                    placeholder="" name="storeqty_<?php echo $key; ?>" id="storeqty_<?php echo $key; ?>" style="cursor:not-allowed;" disabled="true">  
                                                      
                                                       <option value="1" <?php if($storeqty == 1) { echo "selected"; } ?>>Store 1</option>
                                    
                                                       <option value="2" <?php if($storeqty == 2) { echo "selected"; } ?>>Store 2</option>
                                       </select>
                                       
                                       <p class="errorMsg data_storeqty_<?php echo $key; ?>" style="color:#dc3545;display: none;">* This field is invalid
                                       </p>
                                 ...
                                 <div class="maininfoInput12 upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">SKU</label>
                                    <div class="requiredmsg infoInput3 flex flexWrap">
                                       <input type="text" class="infoInputTxt upperCase completeWidth" placeholder=""  name="skurecord_<?php echo $key; ?>" id="skurecord_<?php echo $key; ?>" value="<?php echo $skurecord; ?>" style="cursor:not-allowed;" disabled="true">
                                    </div>
                                 </div>
                                 <div class="maininfoInput12 inputSelectbtn upperCase mRgt0 flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">Total Qty Left</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="total_qty_left_<?php echo $key; ?>" id="total_qty_left_<?php echo $key; ?>" value="<?php if(!empty($total_qty_left)){ echo $total_qty_left; } else {echo "0"; } ?>" style="cursor:not-allowed;width:99px;" readonly>
                                       
                                    </div>
                                 </div>
                              </div>
                              <div class="flex btmBox">
                                 <div class="maininfoInput14  upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel1 labelTitle ">Edit By</label>
                                    <div class="requiredmsg infoInput10 flex flexWrap">
                                       <input type="text" class="infoInputTxt upperCase completeWidth SkuInput" name="enter_<?php echo $key; ?>" id="enter_<?php echo $key; ?>" value="<?php echo $enter; ?>" style="cursor:not-allowed;" disabled="true"> 
                                    </div>
                                     


                                     <p class="errorMsg data_enter_<?php echo $key; ?>" style="color:#dc3545;display: none;">* This field is invalid</p>
                                 </div>
                                 <!-- <div class="cancelSavBtns flex">
                                    <a href="#" class="btn cnlBtn bleedBtn">Cancel</a>
                                    <a href="#" class="btn bleedBtn">Save</a>
                                 </div> -->
                              </div>
                           </div>
                           
                           <?php } } else { ?>
                           <div class="tblRow" id="FullDateYear_1">
                              <div class=" tableGrayBox">
                                 <div class="maininfoInput9 inputSelectbtn upperCase flex">
                                    <div class="flex">
                                       <label for="Fabric Code" class="infoInputLabel13 labelTitle">Date</label>
                                       <input type="date" class="infoInputTxt upperCase infoInput4 inputSltlft data_date_1" name="date_1" id="date_1" placeholder="" style="width:74%;">
                                       <p class="errorMsg dataerr_date_1" style="color:#dc3545;display:none;">* This field is invalid</p>
                                 
                                    </div>
                                  </div>
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">IN &nbsp;</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="in_1" id="in_1" oninput="inchnge();" style="width:99px;">
                                 ...
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" style="margin-left:10px;">OUT</label>
                                    <div class="inpuSltBtn flex">  
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="out_1" id="out_1" id="out_data" oninput="ouchnge();" style="width:99px;">
                                      
                                    </div>

                                    <p class="errorMsg" id="outerr_outerror_out_1" style="color:#dc3545; display:none;">* This field is invalid</p>

                                    <p class="errorMsg" id="lotno1_outerrorstore1_out_1" style="display:none;">* Total quantity must be a valid number less than and equal to quantity in store 1</p>
                                    
                                    <p class="errorMsg" id="lotno2_outerrorstore2_out_1" style="display:none;">Total quantity must be a valid number less than and equal to quantity in store 2</p>

                                 </div>
                                 <div class="maininfoInput5 upperCase flex">   
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" style="margin-left:8px;">Store</label> 
                                    <div class="requiredmsg infoInput1 flex flexWrap" >
                                      
                                       <select type="text" class="infoInputTxt"         style="width: 140px;"
                                                    placeholder="" name="storeqty_1" id="storeqty_1" onchange="getaldata();">  
                                       ...
                                       <p class="errorMsg data_storeqty_1" style="color:#dc3545;display: none;">* This field is invalid
                                       </p>
                                 ...
                                 <div class="maininfoInput12 upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">SKU</label>
                                    <div class="requiredmsg infoInput3 flex flexWrap">
                                       <input type="text" class="infoInputTxt upperCase completeWidth" placeholder=""  name="skurecord_1" id="skurecord_1">
                                    </div>
                                 </div>
                                 <div class="maininfoInput12 inputSelectbtn upperCase mRgt0 flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">Total Qty Left</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="total_qty_left_1" id="total_qty_left_1" style="width:99px;">
                                    </div>
                                 </div>
                              </div>
                              <div class="flex btmBox">
                                 <div class="maininfoInput14  upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel1 labelTitle ">Edit By</label>
                                    <div class="requiredmsg infoInput10 flex flexWrap">
                                       <input type="text" class="infoInputTxt upperCase completeWidth SkuInput" name="enter_1" id="enter_1"> 
                                    </div>
                                     


                                     <p class="errorMsg data_enter_1" style="color:#dc3545;display: none;">* This field is invalid</p>
                                 </div>

                                 <div class="minSaveBtn MainfebInMngmntBtn flex">
                                     <input type="button" onclick="record_deleted(1);" class="saveBtn blueBtn btn febInMngmntBtn" value="Cancel" id="datarecordnwdelete_1" style="background: #ff000085;"> 
                                    <input type="button" onclick="record_created(1);" class="saveBtn blueBtn btn febInMngmntBtn" value="Save" id="datarecordnw_1"> 
                                   
                                       <a href="javascript:void(0)" id="datanw" class="sucsessIconPad editDateinout addDateinout">
                                            <i class="fa fa-check-circle" id="show_data_1" style="display:none; text-align: right; color:#4ab442;"></i>
                                            <i class="fa fa-times-circle" id="err_data_1" style="display:none;text-align: right;color:red;"></i>
                                      </a>
                                </div>
                              </div>
                           </div>
                           ...
                           <input type="hidden" name="totalqtyleftnaew" id="totalqtyleftnaew" value="1">
                           <?php } else { ?>

                           <input type="hidden" name="recordCount" id="recordCount" value="<?php if(empty($recordCount)){echo "0"; }else{echo $recordCount;} ?>">
                           <input type="hidden" name="totalqtyleftnaew" id="totalqtyleftnaew">

                           <?php } ?>

                           <span id="showhtml"> </span>
                           <div class="adbtn_fltrdata">
                              <a href="javascript:void(0)" onClick="addnewrecord()" class=""><img src="https://inventory.deebaco.com/inventory_assets/images/adbtn_fltrdata.png" alt=""></a>
                           </div>
                        </div>
...
<script type="text/javascript">
  ...
  {  
     ...
     $("#data_totalQtyunit_data_"+fabricQtyCount).css('border','1px solid #ececec');
     ...
     {    
         ...
         // $(".total_qtyunit").css("text-transform", "uppercase");
          ...
          // $(".data_error_totalqty_store12").css({'display':'block', 'font-size':'10px','color':'red','padding': '5px 0' });
          $("#data_total_fabric_qty_data_"+fabricQtyCount).css('border','1px solid red');
     ...
     {     
         ...
         //$(".data_error_totalqty_store12").css('display','none');
         $("#data_total_fabric_qty_data_"+fabricQtyCount).css('border','1px solid #ececec');
 ...
 function out_data()
 {
     ...
     toatlqty = total_qty - out_1;
     $("#total_qty").val('');
     $("#total_qty").val(toatlqty);
 ...
 /*function qtystoredata(z)
 {   
     var x = parseInt(z);    
     var totaldata, totalqtydata;
     var indata = $("#in_"+x).val(); 
     var outdata = $("#out_"+x).val();
     
     $("#out_"+x).css("border", "1px solid #ececec");
     if(indata.length != 0)
     {   
     var in_1 = parseInt($("#in_"+x).val());
     
     var storeno = parseInt($("#storeqty_"+x).val());
     $("#lotno1").css("border", "1px solid #ececec");
     $("lotno1_error").css("display", "none");
     $("#lotno2").css("border", "1px solid #ececec");
     $("#lotno2_error").css("display", "none");

     
     $("#lotno2_outerror").css("display", "none");
     $("#lotno1_outerror").css("display", "none");

     if(storeno === 1)
     {
        var store1 = parseInt($("#store1").val());
        var total_qty =  parseInt($("#total_qty").val());
        totaldata = in_1 + store1;
        totalqtydata = in_1 + total_qty;
        $("#store1").val('');
        $("#store1").val(totaldata);
        $("#total_qty").val('');
        $("#total_qty").val(totalqtydata);
        $("#total_qty_left_"+x).val();
        $("#total_qty_left_"+x).val(totalqtydata);
        $("#totalqtyleftnaew").val('');
        $("#totalqtyleftnaew").val(totalqtydata);
        var lotno1 = $("#lotno1").val();
            if(lotno1.length === 0)
            {
               $("#lotno1_error").css("display", "block");
               $("#lotno1_error").css("font-size", "10px");
               $("#lotno1_error").css("color", "red");
               $("#lotno1_error").css("padding", "5px 0px");
               $("#lotno1").css("border", "1px solid red");
            }
            else
            {
               $("lotno1_error").css("display", "none");
     ...
     else if(storeno === 2)
     {
          var store2 = parseInt($("#store2").val());
          var total_qty =  parseInt($("#total_qty").val());
          totaldata = in_1 + store2;
          totalqtydata = in_1 + total_qty;
          $("#store2").val('');
          $("#store2").val(totaldata);
          $("#total_qty").val('');
          $("#total_qty").val(totalqtydata);
          $("#total_qty_left_"+x).val();
          $("#total_qty_left_"+x).val(totalqtydata);
          ...
          var lotno2 = $("#lotno2").val();
              if(lotno2.length === 0)
              {  
                 $("#lotno2_error").css("display", "block");
                 $("#lotno2_error").css("font-size", "10px");
                 $("#lotno2_error").css("color", "red");
                 $("#lotno2_error").css("padding", "5px 0px");
                 $("#lotno2").css("border", "1px solid red");
              }
              else
              {
                $("#lotno2_error").css("display", "none");
    ...
    {  
       ...
       if(storeno === 1)
       {
         ...
         if(out_1 <= store1)
         {
            totaldata = store1 - out_1;
            totalqtydata = total_qty - out_1;
            $("#store1").val('');
            $("#store1").val(totaldata);
            $("#total_qty").val('');
            $("#total_qty").val(totalqtydata);
         ...
         {  
            $("#lotno1_outerror").css("display", "block");
            $("#lotno1_outerror").css("font-size", "10px");
            $("#lotno1_outerror").css("color", "red");
            $("#lotno1_outerror").css("padding", "5px 0px");
            //$("#lotno1_outerror").css("border", "1px solid red");
            $("#out_"+x).css("border", "1px solid red");
         }
       }
       ...
       else if(storeno === 2)
       {
          ...
          {  
            $("#lotno2_outerror").css("display", "block");
            $("#lotno2_outerror").css("font-size", "10px");
            $("#lotno2_outerror").css("color", "red");
            $("#lotno2_outerror").css("padding", "5px 0px");
            //$("#lotno2_outerror").css("border", "1px solid red");
            $("#out_"+x).css("border", "1px solid red");
          }
        }
    }
 ...
 {   
     ...
     $("#out_"+x).css("border", "1px solid #ececec");
     $("#lotno2_outerrorstore2_out_"+x).css("display", "none");
     $("#lotno1_outerrorstore1_out_"+x).css("display", "none");
     if(indata.length != 0)
     {   
     var in_1 = parseInt($("#in_"+x).val());
    ...
    {  
       ...
       if(storeno === 1)
       {
         var store1 = parseInt($("#store1").val());
         var total_qty =  parseInt($("#total_qty").val());
         console.log(out_1+ "---------"+store1 + "-----------"+total_qty);
         if(out_1 <= store1)
         {
            totaldata = store1 - out_1;
            totalqtydata = total_qty - out_1;
         ...
         {  
            $("#lotno1_outerrorstore1_out_"+x).css("display", "block");
            $("#lotno1_outerrorstore1_out_"+x).css("font-size", "10px");
            $("#lotno1_outerrorstore1_out_"+x).css("color", "red");
            $("#lotno1_outerrorstore1_out_"+x).css("padding", "5px 0px");
            //$("#lotno1_outerror").css("border", "1px solid red");
            $("#out_"+x).css("border", "1px solid red");
         }
       }
       ...
       else if(storeno === 2)
       {
          ...
          {  
            $("#lotno2_outerrorstore2_out_"+x).css("display", "block");
            $("#lotno2_outerrorstore2_out_"+x).css("font-size", "10px");
            $("#lotno2_outerrorstore2_out_"+x).css("color", "red");
            $("#lotno2_outerrorstore2_out_"+x).css("padding", "5px 0px");
            //$("#lotno2_outerror").css("border", "1px solid red");
            $("#out_"+x).css("border", "1px solid red");
          }
        }
          ...
          if((new_storeqty_data == '') || (new_storeqty_data == null) || isNaN(new_storeqty_data))
          {
           ...
           var store2 = parseInt($("#store2").val()); 
               ...
               if(new_in_data != '')
               {
                   ...
                   if((isNaN(store1))/* || (new_in_data > store1) */) 
                    {  
                       $("#lotno1_outerrorstore1_in_"+no).css("display", "block");  
                       $("#lotno1_outerrorstore1_in_"+no).css("font-size", "10px");
                       $("#lotno1_outerrorstore1_in_"+no).css("color", "red");
                       $("#lotno1_outerrorstore1_in_"+no).css("padding", "5px 0px");
                       $("#in_"+no).css("border", "1px solid red");
                       $("#nwinerr_inerror_in_"+no).css("display", "none");
                       return 1;
                    }
                    ...
                    else
                    {
                        ...
                        var total_qty =  parseInt($("#total_qty").val());  //alert(total_qty);
                        var indata = parseInt(new_in_data);  //alert(indata);
                        var totalqtydata = indata + total_qty;  //alert(totalqtydata);
                        $(total_qty_left).val('');
                        $(total_qty_left).val(totalqtydata);
                        $("#in_"+no).css("border", "1px solid #ececec");
                        $("#lotno1_outerrorstore1_in_"+no).css("display", "none");
                        $("#nwinerr_inerror_in_"+no).css("display", "none");
          ...
          if((new_storeqty_data == '') || (new_storeqty_data == null) || isNaN(new_storeqty_data))
          {
           ...
           var store2 = parseInt($("#store2").val());
               ...
               if(new_in_data != '')
               {
                   ...
                   if((isNaN(store2)) /*|| (new_in_data > store2) */) 
                    {  
                       $("#lotno1_outerrorstore1_in_"+no).css("display", "block");  
                       $("#lotno1_outerrorstore1_in_"+no).css("font-size", "10px");
                       $("#lotno1_outerrorstore1_in_"+no).css("color", "red");
...
<script>
    function inchnge(){
      /*alert(no);*/ 
       ...
       var in_data = '#in_'+no;
       var new_in_data = $(in_data).val();    // alert(new_in_data);
       var total_qty_left = "#total_qty_left_"+no;
       
       if((new_in_data == '') || (new_in_data == null) || isNaN(new_in_data))
       {
           var total_qty_left = "#total_qty_left_"+no;
           $(total_qty_left).val('0');
           console.log(new_in_data);
         ...
         if(new_storeqty_data == '2')
       {
        ...
        else if((new_in_data == '') || (new_in_data == null))
        { 
           $("#out_"+no).css("border", "1px solid red");
           $("#outerr_outerror_out_"+no).css("display", "block");
           return 1;
        ...
        {  
           ...
           var total_qty =  parseInt($("#total_qty").val());
           var neindata = parseInt(new_in_data);
