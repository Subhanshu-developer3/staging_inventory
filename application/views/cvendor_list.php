        ...
        <div class="mainContentSection flex">
            ...
            <div class="mainRight mainaddFebric">
                <div class="flex tabViewBtns robotoReguler">
                    ...
                    <!--<a href="javascript:void(0)" class="btn upperCase tabViewBtn  whiteBack upperCase">basic Info</a>
                    <a href="javascript:void(0)" class="btn upperCase tabViewBtn whiteBack">Inventory Details</a>
                   
                    <a href="javascript:void(0)" class="btn upperCase tabViewBtn blueBtn ">Vendor Details</a>-->
                
                </div>
                
                    <div class="flex addFebRicTopBtns robotoReguler NoborderRadiusBootm">
                        <div class="VendorListBtn">
                           
                        
                              <button class="btn bleedBtn activeBlueBtn" onClick="addnewcvendordetail('<?php echo $url; ?>')">Add vendor</button>
                        </div>
                    </div>
                    <table class="adminTable robotoReguler" cellpadding="0" cellspacing="0">
                        <thead class="tblHead">
                            <tr class="tableRaw tblHeadRaw robotoMedium NoMargin uppercase">
                                <th class="VendorListtblHeading upperCase">S. No.</th>
                                <th class="VendorListtblHeading upperCase">Vendor Name</th>
                                <th class="VendorListtblHeading upperCase">Primary no.</th>
                                <th class="VendorListtblHeading upperCase">Email</th>
                                <th class="VendorListtblHeading upperCase">GstIN No.</th>
                            </tr>
                        </thead>
                        
                        <tbody style="overflow-y: auto;" class="vendorListcatTableBody">
                            

                            
                            <?php 
                            
                            if(empty($cvendor_detail))
                            { ?>
                            ...
                            <?php } else { 
                            foreach($cvendor_detail as $key => $data) 
                            {  
                                  $i = $key + 1;
                            ?>

                            <tr class="tableBdyRaw">
                                <td class="VendorListtblData upperCase "><?php echo $i ?></td>
                                <td class="VendorListtblData blueText"><?php echo $data->username; ?></td>
                                <td class="VendorListtblData "><?php  echo $data->contact_detail; ?></td>
                                <td class="VendorListtblData">
                                    <a href="javascript:void(0)" onClick="fetch_all_email_detail('<?php echo $data->id; ?>', '<?php echo $url; ?>', '<?php echo $id; ?>')" class=" blueText"><?php echo $data->email; ?> </a>
                                
                                </td>
                                <td class="VendorListtblData"><?php  
