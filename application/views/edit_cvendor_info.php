        ...
        <div class="mainContentSection flex">
            ...
            <div class="mainRight">
                <div class="flex tabViewBtns robotoReguler">
                    <a href="javascript:void(0)" class="btn upperCase tabViewBtn  whiteBack upperCase greenBtn" onClick="info_basic_detail_re_render('<?php echo $url ?>')">basic Info</a>
                ...
                <?php  
                      ...
                      $all_data = json_decode($cvendor_data);

                ?>
                <div class="mainBasicInfoSection">
                    <!-- <form method="post" action="<?php //echo base_url(); ?>change_cvendor_detail"> -->
                        <form method="post">
                        <div class="VendorDeatil">
                            <div class="VendorDetailSection">
                                <div class="VEndorDetailLabelInput robotoReguler mainInfoInputS upperCase flex" style="flex-wrap: wrap;">
                                    <label for="Fabric Code" class="infoInputLabel8 robotoMedium labelTitle">
                                    Name<sup style="color:red;">*</sup>
                                    </label>
                                    <input type="text" name="swatch_card" class="infoInputTxt infoInput8" placeholder="" id="swatch_card" 
                                    value="<?php if(empty($all_data->swatch_card)){} else{ echo $all_data->swatch_card; }?>"  oninput="newcvendor_info_error()" />
                                    <span class="error_cvendor_info" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left: 115px;margin-top: 3px;">* This field is invalid</span>

                                </div>
                            </div>
                            <div class="vendorContact">
                                <p class="heading robotoMedium upperCase">Vendor Contact</p>
                                <div class="flex mainInfoInputS vndrcntctemlalt ">
                                    <div class="vndrcontcteml robotoReguler upperCase flex" style="flex-wrap: wrap;">
                                        <label for="Fabric Code" class="robotoMedium labelTitle">Email<sup style="color:red;">*</sup></label>
                                        <input type="text" name="email" class="infoInputTxt vndrcontctemlInput newcvendoremail" id="email" value="<?php if(empty($all_data->email)){} else{ echo $all_data->email; }?>" oninput="newcvendor_email_error()"/>
                                        <span class="error_cvendor_email" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left:54px;margin-top: 3px;">* This field is invalid</span>
                                    </div>
                                    <div class="vndrcontctno robotoReguler upperCase flex" style="flex-wrap: wrap;">
                                        <label for="Fabric Code" class="robotoMedium labelTitle">Primary No.<sup style="color:red;">*</sup></label>
                                        <input type="text" class="infoInputTxt vndrcontctnoinput newcvendorcontact" name="primary_contact_no"
                                        placeholder=""  id="contact_no"  value="<?php if(empty($all_data->primary_contact_no)){} else{ echo $all_data->primary_contact_no; }?>" oninput="newcvendor_contact_error()"/>
                                        <span class="error_cvendor_contact" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left:98px;margin-top: 3px;">* This field is invalid</span>
                                    </div>
                                    <div class="vndrcontctalt robotoReguler upperCase flex">
                                        <label for="Fabric Code" class="robotoMedium  labelTitle">Alt 1</label>
                                        <input type="text" class="infoInputTxt vndrcontctaltalt" placeholder="" id="alt" name="alt1" value="<?php if(empty($all_data->alt1)){} else{ echo $all_data->alt1; }?>"/>
                                    </div>
                                    <div class="vndrcontctalt robotoReguler upperCase flex">
                                        <label for="Fabric Code" class="robotoMedium labelTitle">Alt 2</label>
                                        <input type="text" class="infoInputTxt vndrcontctaltalt"
                                        placeholder="" name="alt2" id="alt1" value="<?php if(empty($all_data->alt2)){} else{ echo $all_data->alt2; }?>"/>
                                    </div>
                                    <div class="vndrcontctaddress robotoReguler upperCase flex" style="flex-wrap: wrap;">
                                        <label for="Fabric Code" class="robotoMedium labelTitle">Address<sup style="color:red;">*</sup></label>
                                        <input type="text" class="infoInputTxt vndrcontctaltaddress infoInputTxt vndrcontctaltaddress newcvendoraddress"
                                        placeholder="" name="address" id="address" value="<?php if(empty($all_data->address)){} else{ echo $all_data->address; }?>"  oninput="newcvendor_address_error()"/>
                                        <span class="error_cvendor_address" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left:73px;margin-top: 3px;">* This field is invalid</span>
                                    </div>
                                    <div class="vndrcontctGSTIN robotoReguler upperCase flex">
                                        <label for="Fabric Code" class="robotoMedium labelTitle">GSTIN NO.</label>
                                        <input type="text" class="infoInputTxt vndrcontctaltGSTIN"
                                        placeholder="" name="gstin_no" id="gstin_no" value="<?php if(empty($all_data->gstin_no)){} else{ echo $all_data->gstin_no; }?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="vendorContact">
                                <p class="heading robotoMedium upperCase">Fabric Pricing</p>
                                <div class="vndrcontctprice mainInfoInputS robotoReguler upperCase flex">
                                    <label for="Price" class="robotoMedium labelTitle">Price</label>
                                    <div class="PriceNoRups flex">
                                        <input type="text" class="infoInputTxt vndrcontctaltprice upperCase"
                                            placeholder="" id="fabric_cost" name="fabric_cost" value="<?php if(empty($all_data->fabric_cost)){} else{ echo $all_data->fabric_cost; }?>" />
                                        <span class="priceCurrency">( in Rupees )</span>
                                    </div>
                                </div>

                                
                                <div class="mainBillsection  mainInfoInputS">
                                    <div class="vndrcontctbill robotoReguler upperCase flex">
                                       
                                        <label for="Price" class="robotoMedium labelTitle">BIll No.</label> &nbsp; &nbsp;
                                        
                    
                                        
                                        <?php  
                                        
                                        $bill_count = $all_data->bill_count; 
                                        
                                        $nwrecord = json_decode($all_data->bill_no_list); 
                                        
                                        

                                        if(empty($nwrecord->bill_no_list))
                                        {  ?>
                                        <span id="fooBar"> </span>
                                        <!-- <a href="javascript:void(0)" onclick="edit()" class="vendrBillIcon">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen billaddIcon">
                                        ...
                                        <?php   
                                        foreach($nwrecord->bill_no_list as $key => $row) { 
                                         
                
                                         $key_count = $key;
                                         $count = 'bill_no_'.$key_count;

                                            ?> 

                                        <input type="text" class="infoInputTxt vndrcontctaltbill upperCase"
                                            placeholder="" value="<?php echo $row; ?>" id="<?php echo $count; ?>" name="<?php echo $count; ?>"  style="margin: 0 10px 10px 0;"/>
                                        
                                        <?php  } } ?>
                                        

                                        <?php if($bill_count != 0){ ?>
                                              <span id="element_editnew"> </span>
                                        <?php } ?>
                                        <a href="javascript:void(0)" onclick="edit()" class="vendrBillIcon">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen billaddIcon">
                                        ...
                                        <input type="hidden" name="bill_no_total" id="billaddIcon" value="<?php echo $bill_count; ?>">
                                    </div>
                                </div>


                                <div class="mainBillsection  mainInfoInputS">
                                    <div class="vndrDebitnote robotoReguler upperCase flex">
                                        <label for="Price" class="robotoMedium labelTitle">Debit note</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                        
                                        <?php  
                                        
                                        $debit_count = $all_data->debit_count; 
                                        
                                        $debit_note_listrecord = json_decode($all_data->debit_note_list);
                                        
                                        if(empty($nwrecord->bill_no_list))
                                        { ?>
                                        <span id="debitnote"></span>
                                        

                                       <!--  <a href="javascript:void(0)" onclick="debitnote_edit()" class="vendrBillIcon">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen billaddIcon">
                                                <use xlink:href="<?php echo base_url(); ?>SVG/sprite.svg#icon-plus"></use>
                                            </svg>
                                        </a> -->
                                        <?php } else { ?> 
                                        <?php 
                                        foreach($debit_note_listrecord->debit_note_list as $key => $row) { 

                                        
                                         $keynew_count = $key;
                                         $debit_id = 'debit_no_'.$keynew_count;
                                            ?> 

                                        <input type="text"
                                            class="infoInputTxt Debitnoteinput vndrcontctaltprice upperCase"
                                            placeholder="" id="<?php echo $debit_id; ?>" name="<?php echo $debit_id; ?>" value=" <?php echo $row; ?>" style="border: 1px solid #ececec;background-color: #fbfbfb;margin: 0 10px 10px 0;" />
                                         ...
                                         <?php if($debit_count != 0){ ?>
                                               <span id="debitnote_edit"></span>
                                         <?php } ?>
                                         <a href="javascript:void(0)" onclick="debitnote_edit()" class="vendrBillIcon">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen billaddIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-plus"></use>
                                        ...
                                        <input type="hidden" name="debit_note_total" id="debitaddIcon" value="<?php echo $debit_count; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <style type="text/css">
                                    .vndrcontctbill.robotoReguler.upperCase.flex {
                        ...
                        <div class="ImageUpload section">
                            ...
                            <div class="flex fullchooseBrowsFile mainInfoInputS robotoReguler">
                                <div class="mainChoosebrowseFile flex">
                                   <!-- <div class="maininfoInput12 TitleInputBox upperCase browsFile flex">
                                        ...
                                        <label class="custom-file-input filebrows">
                                            <input type="file" name="file_type0" id="file_type0">
                                    ...
                                    <!--<div class="maininfoInput13 TitleInputBox upperCase chooseFils flex">
                                        ...
                                        <label class="custom-file-input fildrag">
                                            <input type="file" name="file_type1" id="file_type1">
                                        </label>
                                    </div>-->
                                    
                                    <div class="maininfoInput13 TitleInputBox upperCase chooseFils flex" style="width:75%;">
                                        <svg viewBox="0 0 32 32" class="icon shapeCodepen chooseFileIcon">
                                            <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-pictures"></use>
                                        </svg>
                                        <label class="custom-file-input fildrag">
                                           <input type="file" name="file_info" id="file_info" onchange="file_info_data()">
                                            <input type="hidden" name="file_info_newdata" id="file_info_newdata" value="<?php 

                                                   if((strlen($all_data->file_info_newdata)) > 0)
                                                   {
                                                      echo $all_data->file_info_newdata;
                                                   }
                                                   else
                                                   {
                                ...
                                max-height: 100px;overflow: hidden;">
                                   ...
                                   if((strlen($all_data->file_info_newdata)) > 0)
                                   { ?>
                                        <img id="infosrc" src="<?php echo $all_data->file_info_newdata; ?>" style="width:100%;" />
                                   ...
                                   <?php }?>
                                    <!-- <button class="imgRmveBtn" onChange="cancel('0')" style="display:none;">x</button> -->
                                ...
                                <div class="minSaveBtn flex">
                                    <input type="button" class="saveBtn upperCase blueBtn btn" value="SAVE" href="javascript:void(0)" onClick="edit_cvendor_detail()">
                                </div>
                            </div>
                        </div>

                        <input type="hidden" name="hash_code" value="<?php echo $url; ?>">
                        <input type="hidden" name="id" value="<?php echo $id;?>"> 
  
                        <input type="hidden" name="cvendor_id" value="<?php echo $cvendor_id; ?>">
