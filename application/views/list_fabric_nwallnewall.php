...
$baseURL = "https://inventory.deebaco.com/index.php/getdata_alldata_getdata_alldata";
$pagConfig = array( 
    'baseURL' => $baseURL, 
    'totalRows' => $rowCount, 
    'perPage' => $limit, 
...
$pagination =  new Paginationall($pagConfig); 
?>
                    ...
                    <table class="adminTable robotoReguler newdata" cellpadding="0" cellspacing="0">
                        ...
                        <?php 
                            ...
                            foreach ($fabric_detail[0][0] as $key => $data) { ?>
