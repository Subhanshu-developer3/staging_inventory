      ...
      <div class="mainContentSection flex">
         ...
         <div class="mainRight">
            <div class="flex tabViewBtns robotoReguler">
               ...
               <a href="javascript:void(0)" class="btn upperCase tabViewBtn whiteBack">Vendor Details</a>
            </div>
            <!-- ===================information=================== -->
            <form action="">
                     ...
                     <div class="flex mainInfoInputS robotoReguler BasicInfoInformaiotn">
                        <div class="maininfoInput1 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput1 flex flexWrap">
                                 <input type="text" id="fabric_code" class="infoInputTxt upperCase completeWidth" value="<?php echo $basic_data->fabric_code; ?>" disabled="true"  style="cursor: not-allowed;"/>
                           ...
                           <div class="product--list-table">
                              <table class="admin-product--tbl">
                                 ...
                                 <tbody>
                                   ...
                                   <p style="text-align:center; padding-top: 48px; font-size: 19px;"> No Records Available</p>
                           </div>
                        </div>
                     </div>
                  </div>
