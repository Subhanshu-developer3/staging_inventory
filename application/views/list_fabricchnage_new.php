...
<body>
    <div class="BasicInfoPage">
        ...
        <div class="header flex">
            ...
            <!--<div class="headerIcons addFebRicHeader flex">
             


             
                <div class="bellUserIcons flex">
               ...
               <!--  <form action=""> -->
                    <div class="flex addFebRicTopBtns robotoReguler">
                        ...
                        <div class="flex addFebricSrchtoggle">
                            <div class="addFebsearchBtn flex">
                                <input type="text" class="upperCase infoInputTxt febricSeach" placeholder="SEARCH">
                    ...
                    <table class="adminTable robotoReguler newdata" cellpadding="0" cellspacing="0">
                        ...
                        <?php 
                            ...
                            <tr class="tableBdyRaw">
                                ...
                                <?php  } else {?>
                                onClick = "edit_info_detail('<?php echo $data->record_slug0; ?>')" <?php } ?>>
                                <?php 
