      ...
      <div class="mainContentSection flex">
         ...
         <div class="mainRight">
            <div class="flex tabViewBtns robotoReguler">
               <a href="basicInfo.html" class="btn upperCase tabViewBtn blueBtn upperCase">basic Info</a>
               <a href="VendorDeatlis.html" class="btn upperCase tabViewBtn whiteBack">Vendor Details</a>
            </div>
            <!-- ===================information=================== -->
            <form action="">
               <div class="mainBasicInfoSection">
                   ...
                   <div class="information section inventoryDetail">
                     <div class="flex mainInfoInputS robotoReguler BasicInfoInformaiotn">
                        <div class="back-arrow flex" onclick="inventory_redirectbasic('<?php echo $url; ?>')">
                             <img src="https://inventory.deebaco.com/inventory_assets/images/back-arrow.png" alt="">
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput10 flex flexWrap">
                              <input type="text" id="defect_type" class="infoInputTxt upperCase completeWidth" placeholder=" ">
                           </div>
                        </div>
                        <div class="maininfoInput1 inputSelectbtn upperCase flex">
                           ...
                           <div class="inpuSltBtn flex">
                              <input type="text"  id="defect_qty"  class="infoInputTxt upperCase infoInput12 inputSltlft">
                              <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18 febricInventoryinput febricInventoryselect  defectQtySelect" style="width:88px;" id="defect_qty_unit"   name="defect_qty_unit">
                                  <option value="" disabled selected hidden class="febricType">select </option>
                                  <?php  
                                  if(!empty($all_unit)){
                                  foreach ($all_unit as $aldata)
                                  { ?>
                                     <option value="<?php echo $aldata->id; ?>" class="febricType"><?php echo $aldata->name; ?></option> 
                        ...
                        <div class="maininfoInput11 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput11 flex flexWrap">
                              <textarea  id="defect_remarks" class="infoInputTxt defctsTxtArea upperCase completeWidth"> </textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           ...
                           <div class="YEsNoBtns flex">
                              <a href="javascript:void(0)" onclick="with_water(true)" id="with_water" class="btn bleedBtn">Yes</a>
                              <a href="javascript:void(0)" onclick="with_water(false)" id="with_water_re" class="btn bleedBtn activeBlueBtn">No</a>
                              <input type="hidden" id="with_water_response" value="off">
                           </div>
                        </div>
                        <div class="maininfoInput13 TitleInputBox upperCase flex">
                           ...
                           <div class="YEsNoBtns YEsNoBtns1 flex">
                              <a href="javascript:void(0)" onclick="with_soap_re(true)" id="with_soap_re_true" class="btn bleedBtn">Yes</a>
                              <a href="javascript:void(0)" onclick="with_soap_re(false)" id="with_soap_re_false" class="btn bleedBtn activeBlueBtn">No</a>
                              <input type="hidden" id="with_soap_response" value="off">
                           </div>
                        </div>
                        <div class="maininfoInput14 TitleInputBox upperCase flex">
                           ...
                           <div class="basicTxtArea">
                             <textarea id="colorbleed_comments" row="3" col="4"class="infoInputTxt lacesinputTxtArea upperCase infoInput14"></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 TitleInputBox upperCase flex">
                            <label for="Fabric Code" class="infoInputLabel12 labelTitle">Before test</label>
                                  <input type="text" id="shrinkage_before_test_h" oninput="shrinkage_nah()" class="infoInputTxt upperCase infoInput12" /><span class="hightwidthlabl">H</span>
                                  <input type="text" id="shrinkage_before_test_w" oninput="shrinkage_naw()" class="infoInputTxt upperCase infoInput12"  /><span class="hightwidthlabl">w</span>
                        </div>
                        <div class="maininfoInput13 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel13 labelTitle">After test</label>
                                 ...
                                 <input type="text" id="shrinkage_fabric_code_w" oninput="shrinkage_codew()" class="infoInputTxt upperCase infoInput13" /><span class="hightwidthlabl">w</span>
                        ...
                        <div class="maininfoInput14 upperCase flex">
                           ...
                           <input type="text" style="height: 36px;" class="infoInputTxt upperCase infoInput12" placeholder="" name="after_shrinkage_qty" id="after_shrinkage_qty">
                           <div class="requiredmsg infoInput12 flex flexWrap">
                              ...
                              id="after_shrinkage_qtyunits" style="width:56%;"> 
                                 <option value="" disabled selected hidden class="febricType">select</option>
                                 <?php  
                                  if(!empty($all_unit)){
                                  foreach ($all_unit as $aldata)
                        ...
                        <div class="maininfofullText TitleInputBox upperCase flex">
                           ...
                           <div class="basicTxtArea">
                                 <textarea id="shrinkage_comments" row="3" col="4" class="infoInputTxt lacesinputTxtArea upperCase infoInput14"></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="return section">
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           ...
                           <div class="inpuSltBtn flex">
                              <input type="text" id="return_qty" name="return_qty" class="infoInputTxt upperCase infoInput12 inputSltlft" style="width:36%;"
                                            placeholder=""/>
                              <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="retnqtyunit1" id="retnqtyunit1" style="width:86px;">
                                 ...
                                 <?php  
                                  ...
                                  foreach ($all_unit as $aldata)
                                  { ?>
                                     <option value="<?php echo $aldata->id; ?>" class="ttlqtyoption"><?php echo $aldata->name; ?></option> 
                                  <?php } } ?>
                        ...
                        <div class="maininfoInput13 inputSelectbtn upperCase flex">
                           ...
                           <input type="date" id="return_date" name="return_date" class="infoInputTxt upperCase width40 " style="width:46%;" placeholder="04-Jan-2022"/>
                        ...
                        <div class="maininfoInput14 upperCase flex">
                           ...
                           <div class="basicTxtArea">
                              <textarea type="textarea" id="return_reason" row="3" col="4" name="return_reason" class="infoInputTxt lacesinputTxtArea upperCase TitleInputBox infoInput11"/></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="fabric-Qty section">
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel12 labelTitle">Total QTY <!--<sup style="color:red;">*</sup>--></label>
                           <div class="inpuSltBtn flex">
                             
                           <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder=""  name="data_total_fabric_qty_data_1" style="width:36%;"  id="data_total_fabric_qty_data_1" oninput="data_total_fabric_qty_data_1_new()">
                           
                              <select type="text"  style="width:86px;" class="infoInputTxt upperCase febricInventoryinput febricInventoryselect " name="data_totalQtyunit_data_1" id="data_totalQtyunit_data_1" onchange="newdataqtyunit()">
                        ...
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel12 labelTitle">Fabric Width <sup style="color:red;">*</sup></label>
                           <div class="inpuSltBtn flex">
                               <input type="text" style="width:99px;"  class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder="" name="data_fabric_width_data_1" id="data_fabric_width_data_1" oninput="fabric_width_datanwerror()">
                               
                                <select  style="width:88px;" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="data_fabricWidthunit_data_1" id="data_fabricWidthunit_data_1">
                        ...
                        <div class="maininfoInput1 inputSelectbtn upperCase flex">
                           <div class="flex">
                              <label for="Fabric Code" class="infoInput15 labelTitle">Date <sup style="color:red;">*</sup></label>
                              <input type="date" class="infoInputTxt upperCase" style="width: 69%;margin-left: 18px;"
                              name="data_fabric_date_data_1" id="data_fabric_date_data_1" oninput="fabric_date_datanwerror()" >
                     ...
                     <div class="flex mainInfoInputS robotoReguler ">
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           <div class="storeBox flex">
                              ...
                              <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft placeholder="  oninput="add_qtynewdata()" id="store1" name="store1" style="width:86px;">

                              <select type="text" style="width:98px;" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="storeunit1" id="storeunit1"  onchange="data_storeunit1()">
                                 <option value="" disabled selected hidden class="febricType">select</option>
                                 <?php  
                                 if(!empty($all_unit)){
                                 foreach ($all_unit as $aldata)
                           ...
                           <span class="lotNothlabl" style="margin-left:10px;padding-top:4px;">LOT No.</span>
                             <input type="text" id="lotno1" name="lotno1" class="infoInputTxt upperCase infoInput12 lotNoinput" placeholder="" oninput="dataerrorlotno1()" /> 
                        ...
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           ...
                           <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder=""  id="store2" name="store2" oninput="add_qty()" style="width:86px;">

                           <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="storeunit2" id="storeunit2" onClick="data_storeunit2()" style="width:98px;">
                                 <option value="" disabled selected hidden class="febricType">select</option>   
                                 <?php  
                                 if(!empty($all_unit)){
                                 foreach ($all_unit as $aldata)
                           ...
                           <span class="lotNothlabl" style="margin-left:10px;padding-top:4px;">LOT No.</span>
                           <input type="text" id="lotno2" name="lotno2"  class="infoInputTxt upperCase infoInput12 lotNoinput" placeholder=""  oninput="dataerrorlotno2()" />
                        ...
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           <div class="storeBox flex">
                              ...
                              <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder=" " id="total_qty" name="total_qty" disabled="true" style="cursor:not-allowed;">
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput14 upperCase flex">
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase TitleInputBox" style="display: none;" name="add_sku_no_2"  id="add_sku_no_2" >
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase TitleInputBox" name="add_sku_no_3" style="display: none;" id="add_sku_no_3">
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase TitleInputBox" name="add_sku_no_4" id="add_sku_no_4" style="display: none;" >
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase TitleInputBox" name="add_sku_no_5" id="add_sku_no_5" style="display: none;" >
                  ...
                  <div class="invenorySaveBtn">
                     <div class="minSaveBtn flex">
                        <input type="button" class="saveBtn upperCase blueBtn btn" value="SAVE"  onClick="add_inventory_detail()" href="javascript:void(0)"  >
                     </div>
                  </div>
                           ...
                           <div class="tblRow" id="FullDateYear_1">
                              <div class=" tableGrayBox">
                                 ...
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" >OUT</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" style="width:99px;" class="infoInputTxt upperCase infoInput12 inputSltlft" name="out_1" id="out_1" id="out_data" oninput="ouchnge();">
                                 ...
                                 <div class="maininfoInput12 upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">SKU</label>
                                    <div class="requiredmsg infoInput3 flex flexWrap">
                                       <input type="text"  style="width:103px;" class="infoInputTxt upperCase completeWidth" placeholder=""  name="skurecord_1" id="skurecord_1">
                                    </div>
                                 </div>
                                 <div class="maininfoInput12 inputSelectbtn upperCase mRgt0 flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">Total Qty Left</label>
                                    <div class="inpuSltBtn flex">
                                       ...
                                       <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18"  style="width:60px;">
                                          <?php  
                                         if(!empty($all_unit)){
                                         foreach ($all_unit as $aldata)
                                         { ?>
...
<script type="text/javascript">
  ...
  {  
     ...
     /*alert($("#total_fabricqty_count").val()); */
     var fabricQtyCount = parseInt($("#total_fabricqty_count").val());  /*alert(fabricQtyCount);*/
