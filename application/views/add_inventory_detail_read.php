                  ...
                  <div class="information section inventoryDetail">
                     <div class="flex mainInfoInputS robotoReguler BasicInfoInformaiotn">
                        <div class="back-arrow flex">
                           ...
                           <a href="javascript:void(0)" onclick="inventory_redirectbasicread('<?php echo $url; ?>')"> <img src="https://inventory.deebaco.com/inventory_assets/images/back-arrow.png" alt=""> </a>
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        ...
                        <div class="maininfoInput14 upperCase flex">
                           ...
                           <div class="requiredmsg infoInput12 flex flexWrap">
                              ...
                              id="after_shrinkage_qtyunits" style="cursor:not-allowed;" disabled="true">
                                  <?php  
                                  if(!empty($all_unit)){
                                  foreach ($all_unit as $aldata)
                                  { ?>
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           ...
                           <div class="inpuSltBtn flex">
                              ...
                              style="cursor:not-allowed;" disabled="true"/>
                              <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="retnqtyunit1" id="retnqtyunit1" style="cursor:not-allowed;" disabled="true">
                  ...
                  <div class="fabric-Qty section">
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           ...
                           value="<?php if(empty($alldata[0]->total_qty)){}else{ echo $alldata[0]->total_qty; }?>" style="cursor:not-allowed;" disabled="true">
                           
                              <select type="text" class="infoInputTxt upperCase febricInventoryinput febricInventoryselect " name="data_totalQtyunit_data_1" id="data_totalQtyunit_data_1" onchange="newdataqtyunit()" style="cursor:not-allowed;" disabled="true">
                        ...
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           ...
                           <div class="inpuSltBtn flex">
                               ...
                               value="<?php if(empty($alldata[0]->fabric_width)){}else{ echo $alldata[0]->fabric_width; }?>" style="cursor:not-allowed;" disabled="true">
                        ...
                        <div class="maininfoInput1 inputSelectbtn  TitleInputBox upperCase flex">
                           <div class="flex">
                              ...
                              value="<?php if(empty($alldata[0]->data_fabric_date_data_1)){}else{ echo $alldata[0]->data_fabric_date_data_1; }?>" style="cursor:not-allowed;" disabled="true">
                  ...
                  <div class="store-Qty section">
                     ...
                     <div class="flex mainInfoInputS robotoReguler ">
                        ...
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           ...
                           <span class="lotNothlabl">LOT No.</span>
                           <input type="text" id="lotno2" name="lotno2"  class="infoInputTxt upperCase infoInput12 lotNoinput" placeholder=""  oninput="dataerrorlotno2()"      value="<?php if(empty($alldata[0]->store1)){ echo '0'; }else{ echo $alldata[0]->lotno1; }?>" style="cursor:not-allowed;" disabled="true"/>
                        ...
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           <div class="storeBox flex">
                              ...
                              <input class="infoInputTxt upperCase infoInput12 inputSltlft total_qtyunit" name="total_qtyunit" id="total_qtyunit" value="UNIT" style="cursor: not-allowed;" readonly="">
                  ...
                  <div class="fnsGoods section">
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput14 upperCase flex">
                           ...
                           <div class="requiredmsg infoInput10 flex flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth"  placeholder="" name="add_sku_no_1" id="add_sku_no_1"   
                              value="<?php if(empty($alldata[0]->add_sku_no_1)){  }else{ echo $alldata[0]->add_sku_no_1; }?>" style="cursor:not-allowed;" disabled="true">
                              <!-- <a href="javascript:void(0)" class="deleteSku blueBtn" id="delete_sku_1" onClick="deleteaSku(1)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="<?php echo base_url();?>SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              ...
                              value="<?php if(empty($alldata[0]->add_sku_no_2)){  }else{ echo $alldata[0]->add_sku_no_2; }?>" style="cursor:not-allowed;" disabled="true">
                          ...
                          <?php } ?>
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              ...
                              value="<?php if(empty($alldata[0]->add_sku_no_3)){  }else{ echo $alldata[0]->add_sku_no_3; }?>" style="cursor:not-allowed;" disabled="true">
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              ...
                              value="<?php if(empty($alldata[0]->add_sku_no_4)){  }else{ echo $alldata[0]->add_sku_no_4; }?>" style="cursor:not-allowed;" disabled="true">
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth TitleInputBox" name="add_sku_no_5" id="add_sku_no_5"
                               value="<?php if(empty($alldata[0]->add_sku_no_5)){  }else{ echo $alldata[0]->add_sku_no_5; }?>" style="cursor:not-allowed;" disabled="true" >
                        ...
                        foreach ($all_records_data as $key => $nwdata) 
                        {
                          ...
                          ?>
                              ...
                              <div class=" tableGrayBox">
                                 <div class="maininfoInput9 inputSelectbtn upperCase flex">
                                    <div class="flex">
                                       ...
                                       value="<?php echo $date; ?>" style="width: 69%; cursor:not-allowed;" readonly>
                                 ...
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    ...
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="in_<?php echo $key; ?>" id="in_<?php echo $key; ?>" value="<?php echo $in; ?>" style="cursor:not-allowed;" readonly>
                                       <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" id="recordin_units_<?php echo $key; ?>"   name="recordin_units_<?php echo $key; ?>" disabled="true" style="cursor: not-allowed;">
                                          <!-- <option value="" disabled selected hidden class="febricType">select Color</option> -->
                                         <?php  
                                         if(!empty($all_unit)){
                                         foreach ($all_unit as $aldata)
                                 ...
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">OUT</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="out_<?php echo $key; ?>" id="out_<?php echo $key; ?>" id="out_data" value="<?php echo $out; ?>" style="cursor:not-allowed;" readonly>
                                       <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" id="recordouta_units_<?php echo $key; ?>"   name="recordouta_units_<?php echo $key; ?>" disabled="true" style="cursor: not-allowed;"> 
                                         <!-- <option value="" disabled selected hidden class="febricType">select Color</option> -->
                                         <?php  
                                         if(!empty($all_unit)){
                                         foreach ($all_unit as $aldata)
                                 ...
                                 <div class="maininfoInput5 upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">Store</label>
                                    <div class="requiredmsg infoInput1 flex flexWrap">
                                      
                                       <select type="text" class="infoInputTxt"
                                 ...
                                 <div class="maininfoInput12 inputSelectbtn upperCase mRgt0 flex">
                                    ...
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="total_qty_left_<?php echo $key; ?>" id="total_qty_left_<?php echo $key; ?>" value="<?php echo $total_qty_left; ?>" style="cursor:not-allowed;" readonly>
                                       <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18"  style="cursor:not-allowed;" disabled="true">
                                          <?php  
                                         if(!empty($all_unit)){
                                         foreach ($all_unit as $aldata)
                                         { ?>
                                              ...
                                              <option value="<?php echo $aldata->id; ?>" 
                                              <?php 
                                                if($aldata->id == $total_qty_lefta_units) { 
                                                echo "selected"; 
                                              } ?> 
                                              class="febricType"><?php echo $aldata->name; ?></option>    
                                         <?php } } ?>
                           ...
                           <div class="tblRow" id="FullDateYear_1">
                              <div class=" tableGrayBox">
                                 <div class="maininfoInput9 inputSelectbtn upperCase flex">
                                    <div class="flex">
                                       <label for="Fabric Code" class="infoInputLabel13 labelTitle">Date</label>
                                       <input type="date" class="infoInputTxt upperCase infoInput4 inputSltlft data_date_1" name="date_1" id="date_1" placeholder="" style="width: 69%;">
                                 ...
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">IN &nbsp;</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="in_1" id="in_1">
                                       <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" id="recordin_units_1"   name="recordin_units_1">
                                          <option value="" disabled selected hidden class="febricType">select unit</option>
                                         <?php  
                                         if(!empty($all_unit)){
                                         foreach ($all_unit as $aldata)
                                         { ?>
                                 ...
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">OUT</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="out_1" id="out_1" id="out_data">
                                       <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" id="recordouta_units_1"   name="recordouta_units_1"> 
                                         <option value="" disabled selected hidden class="febricType">select unit</option>
                                         <?php  
                                         if(!empty($all_unit)){
                                         foreach ($all_unit as $aldata)
                                 ...
                                 <div class="maininfoInput5 upperCase flex">
                                    ...
                                    <div class="requiredmsg infoInput1 flex flexWrap">
                                       ...
                                       <select type="text" class="infoInputTxt"
                                                    placeholder="" name="storeqty_1" id="storeqty_1">  
                                 ...
                                 <div class="maininfoInput12 inputSelectbtn upperCase mRgt0 flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">Total Qty Left</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="total_qty_left_1" id="total_qty_left_1">
                                       <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18">
                                          <?php  
                                         if(!empty($all_unit)){
                                         foreach ($all_unit as $aldata)
                                         { ?>
                           ...
                           <!-- <div class="adbtn_fltrdata">
                              <a href="javascript:void(0)" onClick="addnewrecord()" class=""><img src="<?php echo base_url(); ?>/inventory_assets/images/adbtn_fltrdata.png" alt=""></a>
                           </div> -->
                        </div>
...
<script>
    function inchnge(){
       ...
       var in_data = '#in_'+no;
       var new_in_data = $(in_data).val(); console.log(new_in_data); 
       var total_qty_left = "#total_qty_left_"+no;
