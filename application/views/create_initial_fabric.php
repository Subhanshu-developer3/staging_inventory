...
<html lang="en">
   ...
   <body>
         ...
         <div class="headerIcons flex">
            <a href="#" class="HeaderIcon headerBell">
               <!-- <svg viewBox="0 0 32 32" class="icon shapeCodepen headerBellIcon">
                  <use xlink:href="../SVG/sprite.svg#icon-bell-o"></use>
                  </svg> -->
            ...
            <a href="#" class="HeaderIcon HeaderUser">
               <!-- <svg viewBox="0 0 32 32" class="icon shapeCodepen headerUserIcon">
                  <use xlink:href="../SVG/sprite.svg#user-icon"></use>
                  </svg> -->
      ...
      <div class="mainContentSection flex">
         ...
         <div class="mainRight">
            <div class="flex tabViewBtns robotoReguler">
               ...
               <a href="javascript:void(0)" style="cursor:not-allowed;" disabled="true" class="btn upperCase tabViewBtn whiteBack">Vendor Details</a>
            </div>
            <!-- ===================information=================== -->
            <form action="">
                     ...
                     <div class="flex mainInfoInputS robotoReguler BasicInfoInformaiotn">
                        <div class="maininfoInput1 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput1 flex flexWrap">
                                 <input type="text" id="fabric_code" class="infoInputTxt upperCase completeWidth" placeholder="" oninput="fabricode_error()" />

                                 <!-- <p class="errorMsg">this is demo</p> -->
            
                                 <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_fabric_code">This field is invalid</p>
                                 
                                 <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="fabricode_errornew">This fabric code has already been used</p>
                           </div>
                        ...
                        <div class="maininfoInput2 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput6 flex flexWrap">
                             ...
                             <select type="text" name="fabric_color" id="fabric_color" class="infoInputTxt upperCase completeWidth" onchange="fabricolor_error()">
                               <option value="" disabled selected hidden class="febricType">select Color</option>
                               <?php 
                               if(!empty($colora)){
                               foreach ($colora as  $value) { ?>
                              
                               <option value="<?php echo $value->id; ?>" class="febricType">
                               <?php echo $value->color_name; ?></option>    
                              
                               <?php } } ?>
                             </select>

                             <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_fabric_color">This field is invalid</p>
                        ...
                        <div class="maininfoInput3 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput6 flex flexWrap">
                                ...
                                <select type="text" class="infoInputTxt upperCase  completeWidth" name="fabric_type" id="fabric_type" onchange="fabrictype_error()">
                                  ...
                                  { ?>
                                     ...
                                     <option value="<?php echo $value->id; ?>" class="febricType"><?php echo $value->name; ?></option> 
                                    
                                  <?php } } ?>
                                </select>

                                <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_fabric_type">This field is invalid</p>

                              <!-- <p class="errorMsg">this is demo</p> -->
                           </div>
                        </div>
                        <div class="maininfoInput4 TitleEditBox upperCase flex" id="nwedit1" style="display: none;">
                        ...
                        <input type="hidden" name="fabric_codeid" id="fabric_codeid" value="0">
                        <div class="maininfoInput7 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput7 flex flexWrap">
                              ...
                              <select type="text" name="fabric_pattern" id="fabric_pattern" class="infoInputTxt upperCase completeWidth" onchange="fabricdetail_error()">
                                  ...
                                  <option value="<?php echo $value->id; ?>" class="FabricPattern"><?php echo $value->name; ?></option>    
                                 
                                  <?php } } ?>
                              </select>

                               <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="error_fabric_pattern">This field is invalid</p>
                        ...
                        <div class="maininfoInput8 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput8 flex flexWrap">
                              <input type="text" id="swatch_card" class="infoInputTxt upperCase  completeWidth"
                                 placeholder="" />
                              <!-- <p class="errorMsg">this is demo</p> -->
                           </div>
                        </div>
                        <div class="mainChooseFile upperCase flex">
                           <div class="mainChoosebrowseFile flex">
                              ...
                              <div class="maininfoInput13 TitleInputBox upperCase chooseFils flex">
                                 ...
                                 <p style="display:none; color:red; padding-top:5px; font-size:8px;" class="errorfiledatanw">This field is invalid</p>
                           ...
                           <!-- <div class="imagePalce upperCase">Image</div> -->
                            ...
                            <div class="imagePalce upperCase thumb"><a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                                 ...
                                 <img  id="infosrc" alt="IMAGE" height="36px" width="52px">
                                 </a>
                          </div> 

                         <!-- <div class="imagePalce upperCase thumb">
                                <a type="submit" class="thumbnail upperCase btn link" value="IMAGE"href="#modal-1">Images</a>
                          </div>-->
                        ...
                        <div class="flex SaveBtnRgt">
                           <div class="minSaveBtn flex">
                              <input type="button" class="saveBtn upperCase blueBtn btn" value="SAVE" onClick="info()" id="nwbutton1">
                           </div>
                        </div>
                     </div>
                     <div class="defects section">
                        ...
                        <div class="flex productTable robotoReguler">
                           <div class="product--list-table">
                              ...
                              <?php  ?>
                              <div class="flex productDetailTable">
                                 <div class="minSaveBtn flex">
                                    <a type="submit" class="addPurchaseBtn upperCase blueBtn btn link" value="Add Purchase Detail" style="font-size: 11px;" href="#modal-12">Add Purchase Detail</a>
                                 </div>
                              </div>
                           </div>
                        </div>
    ...
    <!-- popiup model  -->
      <div class="purchasePopup" id="modal-1">
         <a href="#!" class="modal-overlay"></a>
            <div class="modal-dialog modal-dialog-lg">      
               <div class="modal-content ">
                  <p class="heading robotoMedium upperCase"> </p>
                  <div class="titleInputePopup upperCase robotoReguler flex" style="height:230px;">
                     <label for="Invoice ID" class="infoInputLabel1 labelTitle"> </label>
                     <div class="requiredmsg infoInput15 flex flexWrap slides">
                          
                               <img style="margin-left: -30px;"
                               src="https://rukminim1.flixcart.com/image/495/594/kyhlfgw0/dress/1/o/t/xl-dbdr00000347a-deebaco-original-imagapbrsbwy8frg.jpeg?q=50" alt="" width="148px; height:10px;" />
                  ...
                  <div class="prevContainer">
                         <a class="prev" onclick="plusSlides(-1)">
                          <img src="https://inventory.deebaco.com/assets/images/pre-arrow.png" alt="" />
                         </a>
                         <a class="next" onclick="plusSlides(1)">
                         <img style="margin-left: 368px;" src="https://inventory.deebaco.com/assets/images/next-arrow.png" alt="" />
                         </a>
    ...
    <!-- popiup model  -->
      <div class="purchasePopup" id="modal-12">
         <a href="#!" class="modal-overlay"></a>
            <div class="modal-dialog modal-dialog-lg">
               ...
               <div class="modal-content ">
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Invoice ID" class="infoInputLabel1 labelTitle"> Invoice ID <sup style="color:red;">*</sup></label>
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        ...
                        name="cpurchase_qty_units_nwa" id="cpurchase_qty_units">
                            <?php  
                            if(!empty($all_unit)){
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        ...
                        id="fabric_width">
                        <select type="text" class="infoInputTxt upperCase rightSideWidth"
                         name="fabric_width_units_nwa" id="fabric_width_units">
                             <?php  
                            if(!empty($all_unit)){
                            foreach ($all_unit as $aldata)
                            { ?>
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        ...
                        <img src="assets/images/popuprupees.png" alt="" class="">
                     </div>
                  </div>
                  </div>
                  <div class="titleInputePopup upperCase robotoReguler flex">
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     ...
                     <div class="requiredmsg infoInput15 flex flexWrap">
                        ...
                        name="vendor_details" id="vendor_details" required>
                  ...
                  <div class="titleInputePopup upperCase robotoReguler flex">
                     <label for="Date Of Entry" class="infoInputLabel1 labelTitle"> Date Of Entry <sup style="color:red;">*</sup> </label>
                     <div class="requiredmsg infoInput15 flex flexWrap">
                  ...
                  <div class="flex popupBtn robotoReguler">
                     ...
                     <a onclick="createInfomodaldata()" class="btn upperCase blueBtn"> Save</a>
                  </div>
               </div>
            </div>
      </div>
