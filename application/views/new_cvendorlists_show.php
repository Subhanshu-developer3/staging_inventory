...
<html lang="en">
   <head>
      ...
      <title> Vendor Lists Details </title>
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
      <link rel="stylesheet" href="https://inventory.deebaco.com/cvendor/style/style.css" />
   </head>
   <body>
      ...
      <div class="header flex">
         <div class="logo">
            <img src="https://inventory.deebaco.com/cvendor/images/logo.png" alt="" />
         </div>
         <div class="headerIcons flex">
            <a href="#" class="HeaderIcon headerBell">
            <img src="https://inventory.deebaco.com/cvendor/images/notification_icon.png" alt="">
            </a>
            <a href="#" class="HeaderIcon HeaderUser">
            <img src="https://inventory.deebaco.com/cvendor/images/user_login.png" alt="">
            </a>
         </div>
      </div>
      ...
      <div class="mainContentSection flex">
         ...
         <div class="mainLeft">
            <ul class="sidebarMenu robotoReguler">
               <li class="SidemenuItem upperCase submenu"><a href="javascript:void(0);" onClick="fabric()">Fabric</a> 
			       	<!-- <ul>
						    <li class="activesubMenu"><a href='#'>Archive</a></li>
						    <li><a href='#settings'>Unarchive</a></li>
					   </ul> -->
			      </li>
               ...
               <li class="SidemenuItem upperCase activeMenuItem"><a href="javascript:void(0);"> Vendor</a></li>
            </ul>
         </div>
         <div class="mainRight">
            <div class="flex tabViewBtns robotoReguler">
               <a href="javascript:void(0);" onclick="rendercbasicinfoadata('<?php echo $hash_id; ?>')" class="btn upperCase tabViewBtn whiteBack  upperCase">basic Info</a>
               <a href="javascript:void(0);" class="btn upperCase tabViewBtn  blueBtn">Vendor Details</a>
            </div>
            <!-- ===================information=================== -->
            <form action="">
               <div class="mainBasicInfoSection">
                  <div class="flex mainInfoInputS robotoReguler BasicInfoInformaiotn dateInOutStrk">
                     <div class="infoInput12 TitleInputBox upperCase flex">
                        <label for="Fabric Code" class="infoInputLabel8 labelTitle">Fabric Code</label>
                        <div class="requiredmsg infoInput8 flex flexWrap">
                           <input type="text" class="infoInputTxt upperCase  completeWidth" placeholder="" disabled="true"  style="cursor:not-allowed;" value="<?php echo $fabric_code; ?>">
                        </div>
                     </div>
                  </div>
                  <div class="vendorTable section">
                        ...
                        <div class="flex productTable robotoReguler">
                           <div class="product--list-table">
                              <table class="admin-product--tbl">
                                 ...
                                 <tbody>
                                    <?php 
                                    if(!empty($cvendor_all)) { 
                              
                                    foreach($cvendor_details as $key => $detail) {
                                    ...
                                    ?>
                                    <tr>
                                       <td class="firtsChild"><?php echo $i; ?>
                                       </td>
                                       <td>
                                       <a href="javascript:void(0);"
                                       onclick="show_cpurchase_cvendor();"><?php echo $detail->invoiceId;  ?></a>
                                       </td>


                                       <?php 

                                        $nwdata_nw = $this->Crud_model->fetchalldatawithcondition('cvendor_detail','id', $detail->vendor_details);
                                        $nwdatanw = $nwdata_nw[0];
                                       ?>
                                       <td><?php echo $nwdatanw->username; ?></td>
                                       <td><?php echo $nwdatanw->email; ?></td>
                                       <td><?php echo $nwdatanw->contact_detail; ?> </td>
                                       <td><?php echo $nwdatanw->gstin_no; ?></td>
                                       <?php 

                                         $nw = $this->Crud_model->fetchalldatawithcondition('units','id', $detail->cpurchase_qty_units);

                                        
                                        ?>
                                       <td> <?php echo $detail->cpurchase_qty.' '.$nw[0]->name; ?> </td>
                                       
                                       <?php 

                                         $datanw = $this->Crud_model->fetchalldatawithcondition('inventory','fabricpurchaseid', $detail->id);
                                        ?>
                                       <td> 
                                        <?php echo $datanw[0]->remain_qty; ?> mtr</td>
                                       <td> RS.<?php echo $detail->cpriceInfo; ?></td>
                                       <td> RS.<?php echo $detail->total_price; ?> </td>
                                    </tr>
                                    <?php } } ?>
                                 </tbody>
                              </table>
