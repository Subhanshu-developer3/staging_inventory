                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput10 flex flexWrap">
                              <input type="text" id="defect_type" class="infoInputTxt upperCase completeWidth" placeholder=" " value="<?php echo $alldata[0]->defect_type; ?>">
                           </div>
                        </div>
                        <div class="maininfoInput1 inputSelectbtn upperCase flex">
                           ...
                           <div class="inpuSltBtn flex">
                              <input type="text"  id="defect_qty"  class="infoInputTxt upperCase infoInput12 inputSltlft" value="<?php echo $alldata[0]->defect_qty; ?>" >
                              <select type="text" style="width:80px;" class="infoInputTxt upperCase infoInput12 inputSltrgt width18 febricInventoryinput febricInventoryselect  defectQtySelect" id="defect_qty_unit"   name="defect_qty_unit">
                                  ...
                                  <option value="<?php echo $aldata->id; ?>" 
                                     <?php if($aldata->id == $alldata[0]->defect_qty_unit) { 
                                        echo "selected"; 
                                        } ?> 
                        ...
                        <div class="maininfoInput11 TitleInputBox upperCase flex">
                           ...
                           <div class="requiredmsg infoInput11 flex flexWrap">
                              <textarea id="defect_remarks" class="infoInputTxt defctsTxtArea upperCase completeWidth"><?php echo $alldata[0]->defect_remarks; ?> </textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        ...
                        <div class="maininfoInput13 TitleInputBox upperCase flex">
                           ...
                           <?php 
                               ...
                               if($status1 == 2)
                               { ?>
                                    <a href="javascript:void(0)" onclick="with_soap_re(true)" id="with_soap_re_true" class="btn bleedBtn activeBlueBtn">Yes</a>
                                    <a href="javascript:void(0)" onclick="with_soap_re(false)" id="with_soap_re_false" class="btn bleedBtn">No</a>

                                <?php } else { ?>
                                   <a href="javascript:void(0)" onclick="with_soap_re(true)" id="with_soap_re_true" class="btn bleedBtn" 
                                   >Yes</a>
                                   <a href="javascript:void(0)" onclick="with_soap_re(false)" id="with_soap_re_false" class="btn bleedBtn activeBlueBtn">No</a>
                               <?php } } else { ?>
                                   <a href="javascript:void(0)" onclick="with_soap_re(true)" id="with_soap_re_true" class="btn bleedBtn" 
                                   >Yes</a>
                        ...
                        <div class="maininfoInput14 TitleInputBox upperCase flex">
                           ...
                           <div class="basicTxtArea">
                             <textarea id="colorbleed_comments" row="3" col="4"class="infoInputTxt lacesinputTxtArea upperCase infoInput14"> <?php echo $alldata[0]->colorbleed_comments; ?></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 TitleInputBox upperCase flex">
                            <label for="Fabric Code" class="infoInputLabel12 labelTitle">Before test</label>
                                  <input type="text" id="shrinkage_before_test_h" oninput="shrinkage_nah()" class="infoInputTxt upperCase infoInput12" 
                                     value="<?php if(empty($alldata[0]->shrinkage_before_test_h)){}else{ echo $alldata[0]->shrinkage_before_test_h;} ?>" /><span class="hightwidthlabl">H</span>
                                 <input type="text" id="shrinkage_before_test_w" oninput="shrinkage_naw()" class="infoInputTxt upperCase infoInput12"
                                     value="<?php if(empty($alldata[0]->shrinkage_before_test_w)){}else{ echo $alldata[0]->shrinkage_before_test_w;} ?>" /><span class="hightwidthlabl">w</span>
                        </div>
                        <div class="maininfoInput13 TitleInputBox upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel13 labelTitle">After test</label>
                                 ...
                                 <input type="text" id="shrinkage_fabric_code_h" oninput="shrinkage_codeh()" class="infoInputTxt upperCase infoInput13"  
                                    value="<?php if(empty($alldata[0]->shrinkage_fabric_code_h)){}else{ echo $alldata[0]->shrinkage_fabric_code_h;} ?>"/>
                                 ...
                                 <input type="text" id="shrinkage_fabric_code_w" oninput="shrinkage_codew()" class="infoInputTxt upperCase infoInput13" 
                                    value="<?php if(empty($alldata[0]->shrinkage_fabric_code_w)){}else{ echo $alldata[0]->shrinkage_fabric_code_w;} ?>" /><span class="hightwidthlabl">w</span>
                        ...
                        <div class="maininfoInput14 upperCase flex">
                           <label for="Fabric Code" class="infoInputLabel14 labelTitle">After Shrinkage Qty</label>
                            <input type="text" style="height: 36px;" class="infoInputTxt upperCase infoInput12" placeholder="" name="after_shrinkage_qty" id="after_shrinkage_qty" value="<?php if(empty($alldata[0]->after_shrinkage_qty)){}else{ echo $alldata[0]->after_shrinkage_qty;} ?>">
                        ...
                        <div class="maininfofullText TitleInputBox upperCase flex">
                           ...
                           <div class="basicTxtArea">
                                 <textarea id="shrinkage_comments" row="3" col="4" class="infoInputTxt lacesinputTxtArea upperCase infoInput14"><?php if(empty($alldata[0]->shrinkage_comments)){}else{ echo $alldata[0]->shrinkage_comments;} ?></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="return section">
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           ...
                           <div class="inpuSltBtn flex"> 
                              <input type="text" id="return_qty" name="return_qty" class="infoInputTxt upperCase infoInput12 inputSltlft" placeholder="" value="<?php if(empty($alldata[0]->return_qty)){}else{ echo $alldata[0]->return_qty; }?>" style="width:46px;"/>
                              <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="retnqtyunit1" id="retnqtyunit1" style="width:83px;">
                                <option value="" disabled selected hidden class="febricType">select </option>
                                  <?php  
                                  if(!empty($all_unit)){
                                  foreach ($all_unit as $aldata)
                        ...
                        <div class="maininfoInput13 inputSelectbtn upperCase flex">
                           ...
                           <input type="date" id="return_date" name="return_date" class="infoInputTxt upperCase" style="width: 69%;" placeholder="04-Jan-2022"  value="<?php 
                                            if(empty($alldata[0]->return_date)){}else{ echo $alldata[0]->return_date; }?>"/>
                        ...
                        <div class="maininfoInput14 upperCase flex">
                           ...
                           <div class="basicTxtArea">
                              <textarea type="textarea" id="return_reason" row="3" col="4" name="return_reason" class="infoInputTxt lacesinputTxtArea upperCase TitleInputBox infoInput11"/><?php if(empty($alldata[0]->return_reason)){}else{ echo $alldata[0]->return_reason; }?></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="fabric-Qty section">
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           ...
                           value="<?php if(empty($alldata[0]->total_qty)){ echo "0"; }else{ echo $alldata[0]->total_qty; }?>" style="cursor:not-allowed;width:68px;" disabled="true">
                              ...
                              <select type="text" class="infoInputTxt upperCase febricInventoryinput febricInventoryselect " name="data_totalQtyunit_data_1" id="data_totalQtyunit_data_1" onchange="newdataqtyunit()" style="cursor:not-allowed;" disabled="true">
                                 <option value="" class="febricType" disabled="" selected="" hidden="">Select
                                 </option>
                        ...
                        <div class="maininfoInput12 inputSelectbtn upperCase flex">
                           ...
                           <div class="inpuSltBtn flex">
                               ...
                               value="<?php if(empty($alldata[0]->fabric_width)){}else{ echo $alldata[0]->fabric_width; }?>" style="cursor:not-allowed;width:60px;" disabled="true">
                                ...
                                <select  class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="data_fabricWidthunit_data_1" id="data_fabricWidthunit_data_1" 
                                 style="cursor:not-allowed;width:68px;" disabled="true">
                        ...
                        <div class="maininfoInput1 inputSelectbtn  TitleInputBox upperCase flex">
                           <div class="flex">
                              ...
                              <input type="text" style="width:190px;" class="infoInputTxt upperCase infoInput1 inputSltlft" placeholder="04-Jan-2022" name="data_fabric_date_data_1" id="data_fabric_date_data_1" oninput="fabric_date_datanwerror()" 
                        ...
                        <!------code_added-------->
                        <!------code_added-------->
                        <span id="showfabricqtyhtml"></span>
                        <input type="hidden" name="total_data" id="total_fabricqty_count" value="1">
                        <input type="hidden" name="total_disablefabricqty_count" id="total_disablefabricqty_count" value="0">
                     ...
                     <div class="flex mainInfoInputS robotoReguler ">
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           <div class="storeBox flex">
                              ...
                              <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft placeholder="  oninput="add_qtynewdata()" id="store1" name="store1" value="<?php if(empty($alldata[0]->store1)){ echo '0'; }else{ echo $alldata[0]->store1; }?>">

                              <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="storeunit1" id="storeunit1"  onchange="data_storeunit1()" disabled="true">
                           ...
                           <span class="lotNothlabl">LOT No.</span>
                             <input type="text" id="lotno1" name="lotno1" class="infoInputTxt upperCase infoInput12 lotNoinput" placeholder="" oninput="dataerrorlotno1()" value="<?php if(empty($alldata[0]->store1)){ echo '0'; }else{ echo $alldata[0]->lotno1; }?>"/> 
                        ...
                        <div class="maininfoInput2 bgBox inputSelectbtn upperCase TitleInputBox flex">
                           ...
                           value="<?php if(empty($alldata[0]->store2)){ echo '0'; }else{ echo $alldata[0]->store2; }?>" >

                           <select type="text" class="infoInputTxt upperCase infoInput12 inputSltrgt width18" name="storeunit2" id="storeunit2" onClick="data_storeunit2()" disabled="true">
                                 <!-- <option value="" class="febricType" disabled="" selected="" hidden="">MM
                                 </option> -->
                                 <!-- <option value="" disabled selected hidden class="FabricPattern">Select Unit</option> -->
                           ...
                           <span class="lotNothlabl">LOT No.</span>
                           <input type="text" id="lotno2" name="lotno2"  class="infoInputTxt upperCase infoInput12 lotNoinput" placeholder=""  oninput="dataerrorlotno2()"      value="<?php if(empty($alldata[0]->store2)){ echo '0'; }else{ echo $alldata[0]->lotno2; }?>"/>
...
;                                    }
                  ...
                  <div class="fnsGoods section">
                     ...
                     <div class="flex mainInfoInputS robotoReguler">
                        <div class="maininfoInput14 upperCase flex">
                           ...
                           <div class="requiredmsg infoInput10 flex flexWrap">
                              <input type="text" class="infoInputTxt upperCase"  placeholder="" name="add_sku_no_1" id="add_sku_no_1">
                              <a href="javascript:void(0)" class="deleteSku blueBtn" id="delete_sku_1" onClick="deleteaSku(1)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a>
                           </div>
                           <?php } else { ?> 
                           ...
                           <div class="requiredmsg infoInput10 flex flexWrap">
                              <input type="text" class="infoInputTxt upperCase"  placeholder="" name="add_sku_no_1" id="add_sku_no_1"   
                              value="<?php if(empty($alldata[0]->add_sku_no_1)){  }else{ echo $alldata[0]->add_sku_no_1; }?>">
                              <a href="javascript:void(0)" class="deleteSku blueBtn" id="delete_sku_1" onClick="deleteaSku(1)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase TitleInputBox" name="add_sku_no_2"  id="add_sku_no_2" 
                              value="<?php if(empty($alldata[0]->add_sku_no_2)){  }else{ echo $alldata[0]->add_sku_no_2; }?>">
                              <a href="javascript:void(0)"  class="deleteSku blueBtn"  id="delete_sku_2" onClick="deleteaSku(2)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a>
                          ...
                          <?php } ?>
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase TitleInputBox" name="add_sku_no_3"  id="add_sku_no_3"
                              value="<?php if(empty($alldata[0]->add_sku_no_3)){  }else{ echo $alldata[0]->add_sku_no_3; }?>">
                              <a href="javascript:void(0)"  class="deleteSku blueBtn"  id="delete_sku_3" onClick="deleteaSku(3)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a>
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase TitleInputBox" name="add_sku_no_4" id="add_sku_no_4"
                              value="<?php if(empty($alldata[0]->add_sku_no_4)){  }else{ echo $alldata[0]->add_sku_no_4; }?>">
                              <a href="javascript:void(0)" class="deleteSku blueBtn"   id="delete_sku_4" onClick="deleteaSku(4)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              </a>
                           ...
                           <div class="requiredmsg infoInput10 flex SkuInput flexWrap">
                              <input type="text" class="infoInputTxt upperCase completeWidth TitleInputBox" name="add_sku_no_5" id="add_sku_no_5"
                               value="<?php if(empty($alldata[0]->add_sku_no_5)){  }else{ echo $alldata[0]->add_sku_no_5; }?>">
                              <a href="javascript:void(0)" class="deleteSku blueBtn"  id="delete_sku_5" onClick="deleteaSku(5)">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen deleteSkuIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-trash"></use>
                                            </svg>
                              ...
                              <a href="javascript:void(0)" class="addSku"id="addSku"  onClick="addaSku()">
                                            <svg viewBox="0 0 32 32" class="icon shapeCodepen addSkuIcon">
                                                <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-plus"></use>
                                            </svg>
                              </a>
                              ...
                              <input type="hidden" id="addskuCount" name="addskuCount" value="<?php echo $addskudata; ?>">
                           </div>
                  ...
                  <div class="invenorySaveBtn">
                     <div class="minSaveBtn flex">
                        <input type="button" class="saveBtn upperCase blueBtn btn" value="SAVE"  onClick="edit_chnage_inventory_nwdetail()" href="javascript:void(0)">
                     </div>
                  </div>
                              ...
                              <div class=" tableGrayBox">
                                 <div class="maininfoInput9 inputSelectbtn upperCase flex">
                                    <div class="flex">
                                       ...
                                       value="<?php echo $date; ?>" style="width:74%; cursor:not-allowed;" readonly> 
                                 ...
                                 <div class="maininfoInput5 inputSelectbtn upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" style="margin-left:5px;">OUT</label>
                                    <div class="inpuSltBtn flex">
                                       <input type="text" style="width:60px;" class="infoInputTxt upperCase infoInput12 inputSltlft" name="out_<?php echo $key; ?>" id="out_<?php echo $key; ?>" id="out_data" value="<?php echo $out; ?>" style="cursor:not-allowed;width:99px;" readonly>
                                 ...
                                 <div class="maininfoInput5 upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" style="margin-left:5px;">Store</label>
                                    <div class="requiredmsg infoInput1 flex flexWrap">
                                    
                                    
                                    
                                       <input type="text" class="infoInputTxt"
                                                    placeholder="" name="storeqty_<?php echo $key; ?>" value="<?php if($storeqty == 1) { echo "Store 1"; }elseif($storeqty == 2) { echo "Store 2"; }  ?>" id="storeqty_<?php echo $key; ?>" style="cursor:not-allowed;width:60px;" disabled="true"> 
                                 ...
                                 <div class="maininfoInput12 upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle" style="margin-left:10px;">SKU</label>
                                 ...
                                 <div class="maininfoInput12 inputSelectbtn upperCase mRgt0 flex">
                                    ...
                                    <div class="inpuSltBtn flex">
                                       <input type="text" class="infoInputTxt upperCase infoInput12 inputSltlft" name="total_qty_left_<?php echo $key; ?>" id="total_qty_left_<?php echo $key; ?>" value="<?php if(!empty($total_qty_left)){ echo $total_qty_left; } else {echo "0"; } ?>"  style="cursor:not-allowed;width:148px;font-size:15px;" readonly>
