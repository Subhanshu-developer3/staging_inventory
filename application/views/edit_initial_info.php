            ...
            <div class="mainRight">
               ...
               <?php 
                ...
                <div class="flex tabViewBtns robotoReguler">
                    ...
                    <a href="javascript:void(0)" class="btn upperCase tabViewBtn whiteBack" onClick="edit_show_inventory_detail_on_redirect('<?php echo $slugid; ?>')">Inventory Details</a>
                    <!-- <a href="javascript:void(0)" class="btn upperCase tabViewBtn whiteBack" onClick="chnage_re_render_basic_info_detail('<?php //echo $slugid; ?>', '<?php //echo $record_id; ?>')">Inventory Details</a> -->
                    <a href="javascript:void(0)" class="btn upperCase tabViewBtn whiteBack" onClick="edit_show_cvendor_detail_on_redirect('<?php echo $slugid; ?>')">Vendor Details</a>
                       ...
                       {
                         if(empty(json_decode($all_data->basic_data))){}
                         else
                         {
                           $re_render_data = json_decode($all_data->basic_data);
                ...
                <form>
                    <div class="mainBasicInfoSection">
                        <div class="information section">
                            <p class="heading robotoMedium upperCase">Information</p>
                            <div class="flex mainInfoInputS robotoReguler  BasicInfoInformaiotn">
                                <div class="maininfoInput1 TitleInputBox upperCase flex editinfo">
                                    <label for="Fabric Code" class="infoInputLabel1 labelTitle">Fabric Code<sup style="color:red;">*</sup></label>
                                    <input type="text" id="fabric_code" class="infoInputTxt upperCase infoInput1" value="<?php if(empty($re_render_data->fabric_code)){}else{ echo $re_render_data->fabric_code;} ?>"   oninput="fabricode_error()"  style="cursor:not-allowed;" readonly />
                                ...
                                <!--<div class="maininfoInput2 TitleInputBox upperCase flex editinfo">
                                    <label for="Fabric Code" class="infoInputLabel2 labelTitle">Fabric Color<sup style="color:red;">*</sup></label>
                                    <input type="text" id="fabric_color" class="infoInputTxt upperCase infoInput2" value="<?php if(empty($re_render_data->fabric_color)){}else{ echo $re_render_data->fabric_color;} ?>"  oninput="fabricolor_error()"/>
                                    <span class="error_fabric_color" style="display:none;font-size:10px;color: #dc3545;width:calc(100% - 105px);margin-left:110px;margin-top: 3px;">* This field is invalid</span>
                                </div>-->
                                
                                
                                <div class="maininfoInput7 TitleInputBox upperCase flex" style="flex-wrap: wrap;"><label for="Fabric Code" class="infoInputLabel7 labelTitle">Fabric
                                        Color<sup style="color:red;">*</sup></label>
                                    <select type="text" name="fabric_color" id="fabric_color" class="infoInputTxt upperCase infoInput7" onchange="fabricolor_error()">
                                        <option value="" disabled selected hidden class="FabricPattern">select Color</option>
                                        ...
                                        if($value->id == $re_render_data->fabric_color) { 
                                        echo "selected"; 
                                        } ?> class="FabricPattern"><?php echo $value->color_name; ?></option>    
                                ...
                                <div class="maininfoInput3 TitleInputBox upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel3 labelTitle">Vendor</label>
                                    <input type="text" id="vendor" class="infoInputTxt upperCase infoInput3" value="<?php if(empty($re_render_data->info_data)){}else{ echo $re_render_data->info_data;} ?>" />
                                </div>
                                ...
                                <div class="maininfoInput6 TitleInputBox upperCase flex editinfo">
                                    <label for="Fabric Code" class="infoInputLabel6 labelTitle">Fabric Type<sup style="color:red;">*</sup></label>
                                    <select type="text" name="fabric_type" class="infoInputTxt upperCase infoInput6" onchange="fabrictype_error()">
                                        <option value="" class="febricType" disabled selected hidden>Select type</option>
                                              <?php 
                                              if(!empty($fabric_type)){
                                              foreach ($fabric_type as $value)
                                              { ?>
                                                
                                                 <option value="<?php echo $value->id; ?>"   class="febricType" <?php 
                                                if($value->id == $re_render_data->fabric_type) { 
                                                echo "selected"; 
                                                } ?>> <?php echo $value->name; ?>
                                                </option> 
                                             <?php } } ?>
                                ...
                                <div class="maininfoInput7 TitleInputBox upperCase flex editinfo">
                                    <label for="Fabric Code" class="infoInputLabel7 labelTitle">Fabric
                                        Pattern<sup style="color:red;">*</sup></label>
                                    <select type="text"name="fabric_pattern" class="infoInputTxt upperCase infoInput7" onchange="fabricdetail_error()">
                                        ...
                                        <option value="<?php echo $value->id; ?>" <?php 
                                        if($value->id == $re_render_data->fabric_pattern) { 
                                        echo "selected"; 
                                ...
                                <div class="maininfoInput8 TitleInputBox upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel8 labelTitle">Swatch Card No.</label> &nbsp;
                                    <input type="text" id="swatch_card" class="infoInputTxt upperCase infoInput8" value="<?php if(empty($re_render_data->swatch_card)){}else{ echo $re_render_data->swatch_card;} ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="defects section">
                            <p class="heading robotoMedium upperCase">Defects</p>
                            <div class="flex mainInfoInputS robotoReguler">
                                <div class="maininfoInput9 TitleInputBox upperCase flex editinfo">
                                    <label for="Fabric Code" class="infoInputLabel1 labelTitle">Defect Type</label>
                                    <input type="text" id="defect_type" class="infoInputTxt upperCase infoInput9" value="<?php if(empty($re_render_data->defect_type)){}else{ echo $re_render_data->defect_type;} ?>"/>
                                    
                                </div>
                                


                                <div class="maininfoInput10 TitleInputBox upperCase flex" style="flex-wrap: wrap;">
                                    <label for="Fabric Code" class="infoInputLabel2 labelTitle">Defect Qty</label>
                                    <div class="defectInventinput1 requiredmsg flex editinfo">
                                        <input type="text" class="defectQtyInput infoInputTxt upperCase febricInventoryinput" id="defect_qty" value="<?php if(empty($re_render_data->defect_qty)){}else{ echo $re_render_data->defect_qty;} ?>">
                                        <select class="infoInputTxt febricInventoryinput febricInventoryselect  defectQtySelect" name="fabric_width_unit">
                                          <?php 
                                              if(!empty($all_unit)){
                                              foreach ($all_unit as $value)
                                              { ?>
                                                
                                                 <option value="<?php echo $value->id; ?>"   class="ttlqtyoption" <?php 
                                                if($value->id == $re_render_data->fabric_defect_qty) { 
                                                echo "selected"; 
                                                } ?>> <?php echo $value->name; ?>
                                                </option> 
                                             <?php } } ?>
                                ...
                                <div class="maininfoInput11 TitleInputBox upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel3 labelTitle">Defect
                                        Remarks</label>
                                    <input type="text" id="defect_remarks" class="infoInputTxt upperCase infoInput11" value="<?php if(empty($re_render_data->defect_remarks)){}else{ echo $re_render_data->defect_remarks;} ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="shirnkage section">
                            ...
                            <div class="flex mainInfoInputS robotoReguler">
                                <div class="maininfoInput12 TitleInputBox upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel12 labelTitle">Before test<sup style="color:red;">*</sup></label>
                                    <input type="text" id="shrinkage_before_test_h" oninput="shrinkage_nah()" class="infoInputTxt upperCase infoInput12" value="<?php if(empty($re_render_data->shrinkage_before_test_h)){}else{ echo $re_render_data->shrinkage_before_test_h;} ?>"/><span>H</span>
                                    <input type="text" id="shrinkage_before_test_w" oninput="shrinkage_naw()"  class="infoInputTxt upperCase infoInput12" value="<?php if(empty($re_render_data->shrinkage_before_test_w)){}else{ echo $re_render_data->shrinkage_before_test_w;} ?>"/><span>w</span>
                                </div>
                                <div class="maininfoInput13 TitleInputBox upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel13 labelTitle">After test<sup style="color:red;">*</sup></label>
                                    <input type="text" id="shrinkage_fabric_code_h" oninput="shrinkage_codeh()" class="infoInputTxt upperCase infoInput13" value="<?php if(empty($re_render_data->shrinkage_fabric_code_h)){}else{ echo $re_render_data->shrinkage_fabric_code_h;} ?>"/><span>H</span>
                                    <input type="text" id="shrinkage_fabric_code_w" oninput="shrinkage_codew()" class="infoInputTxt upperCase infoInput13" value="<?php if(empty($re_render_data->shrinkage_fabric_code_w)){}else{ echo $re_render_data->shrinkage_fabric_code_w;} ?>"/><span>w</span>
                                </div>
                                <div class="maininfoInput14 TitleInputBox upperCase flex">
                                    ...
                                    <textarea id="shrinkage_comments" row="3" col="4"class="infoInputTxt commenttxtarea  infoInput14"><?php if(empty($re_render_data->shrinkage_comments)){}else{ echo $re_render_data->shrinkage_comments;} ?>
                                    </textarea>
                            ...
                            <div class="flex mainInfoInputS robotoReguler">
                                <div class="maininfoInput12 TitleInputBox upperCase flex">
                                    ...
                                    <div class="YEsNoBtns flex">
                                     <?php 
                                     if(!empty($re_render_data->with_water_response))
                                     {  

                                     if($re_render_data->with_water_response === "on")
                                     { ?>

                                         <a href="javascript:void(0)" onclick="with_water(true)" id="with_water" class="btn bleedBtn activeBlueBtn" >Yes</a>
                                         <a href="javascript:void(0)" onclick="with_water(false)" id="with_water_re" class="btn bleedBtn ">No</a>
                                    <?php } else {  ?>
                                ...
                                <div class="maininfoInput13 TitleInputBox upperCase flex">
                                    ...
                                    <div class="YEsNoBtns YEsNoBtns1 flex">
                                        ...
                                        if(!empty($re_render_data->with_soap_response))
                                        {  
                                        
                                        if($re_render_data->with_soap_response === "on")
                                        { ?>
                                ...
                                <div class="maininfoInput14 TitleInputBox upperCase flex">
                                    <label for="Fabric Code" class="infoInputLabel14 labelTitle">Comments</label>
                                    <textarea id="colorbleed_comments" row="3" col="4"class="infoInputTxt commenttxtarea  infoInput14"><?php if(empty($re_render_data->colorbleed_comments)){}else{ echo $re_render_data->colorbleed_comments;} ?>
                                    </textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex fullchooseBrowsFile mainInfoInputS robotoReguler">
                                ...
                                style="flex-wrap:wrap;">
                                    ...
                                    <!--<div class="maininfoInput13 TitleInputBox upperCase chooseFils flex">
                                     ...
                                     <div class="maininfoInput13 TitleInputBox upperCase chooseFils flex" style="width:75%;" id="errorfiledatanw">
                                        <svg viewBox="0 0 32 32" class="icon shapeCodepen chooseFileIcon">
                                            <use xlink:href="https://inventory.deebaco.com/SVG/sprite.svg#icon-pictures"></use>
                                        </svg>
                                        <label class="custom-file-input fildrag">
                                           <input type="file" name="file_info" id="file_info">
                                            <input type="hidden" name="file_info_newdata" id="file_info_newdata" value="<?php 

                                                   if((strlen($re_render_data->file_info_newdata)) > 0)
                                                   {
                                                      echo $re_render_data->file_info_newdata;
                                                   }
                                                   else
                                                   {
                               ...
                               <div class="imagePalce upperCase" style="position:relative;max-width: 90px;
                                max-height: 100px;overflow: hidden;">
                                <?php 

                               if((strlen($re_render_data->file_info_newdata)) > 0)
                               { ?>
                                    <img id="infosrc" src="<?php echo $re_render_data->file_info_newdata; ?>" style="width:100%;" />
                               

                               <?php } else {?>
                               
                                     <img id="infosrc" style="width:100%;" />
                               <?php }?>

                                    
                                    <!-- <button class="imgRmveBtn" onChange="cancel('<?php echo $id; ?>')" 
                                           <?php 
                                           if((strlen($re_render_data->file_info_newdata)) > 0)
                                           { ?>
                                           style="display:block;"
                                ...
                                <div class="mainTitleSwatches flex editinfo">
                                    <label class="addeddBy labelTitle">Added by</label>
                                    <div class="swatchesFullName flex swatchinfoFname editinfo">
                                        <input type="text" id="fullname"  class="fullNmebasciInfo transparent brdrNone" value="<?php if(empty($re_render_data->fullname)){}else{ echo $re_render_data->fullname;} ?>" oninput="fullname_error()">
                                        <span class="error_fullname" style="display:none;font-size:12px;color: #dc3545;width:calc(100% - 105px);margin-left: -4px;margin-top: 3px;">* This field is invalid</span>
                                        
                                    </div>
                                </div>
                                <div class="minSaveBtn flex">
                                    
                                    <input type="button" onClick="chnage_re_render_basic_info_detail('<?php echo $slugid; ?>', '<?php echo $record_id; ?>')" class="saveBtn upperCase blueBtn btn" value="NEXT">
                                </div>
                            </div>
                        </div>
                    </div>
